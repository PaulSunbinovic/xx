...
class ZsstdAction extends Action{
...
// 		$stdls=$std->select();
		...
		$fldint='-stdid-bxxsnm-f_std_grdid-f_stdxqcls_xqid-f_stdxqcls_clsid-stdaplno-stdno-stdnm-sexnm-stdbtd-mjnm-stdaddtm-statnm-';
