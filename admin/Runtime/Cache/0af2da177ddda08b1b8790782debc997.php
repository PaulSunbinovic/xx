...
<script type='text/javascript' src='__PUBLIC__/JS/admin/cstmgrpcstmrl.js'></script>
			...
			<div class="panel panel-default">
				...
				<!-- NB 开始 -->
				    ...
				    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
				      <div class="panel-body">
						...
						<div id='NBsrcMpart'>
							<form>
							SELECT * FROM tb_cstmgrpcstmrl LEFT JOIN tb_cstmgrp ON f_cstmgrpcstmrl_cstmgrpid=cstmgrpid LEFT JOIN tb_cstmrl ON f_cstmgrpcstmrl_cstmrlid=cstmrlid WHERE ahnm LIKE '%Ad%' AND f_cstmgrpcstmrl_cstmgrpid=1 ORDER BY cstmgrpcstmrlid ASC LIMIT 0,10
				      ...
				      <!-- 暂时结束 -->
						<div id='flddv'>
							字段：<!-- uid必须有且不用看见 -->
							<input type="checkbox" id='cstmgrpcstmrlidfld' value='cstmgrpcstmrlid' style='display:none' checked=checked/>
							<input type="checkbox" id='cstmgrpnmfld' value='cstmgrpnm'/>团队名称&nbsp;&nbsp;
							<input type="checkbox" id='cstmrlnmfld' value='cstmrlnm'/>角色名称&nbsp;&nbsp;
						</div>
						<div id='cdtdv'>
							条件：
							团队名称
							<select name='f_cstmgrpcstmrl_cstmgrpid' id='f_cstmgrpcstmrl_cstmgrpidcdt'  class='input-small'>
							<option value=''>无</option>
							<?php echo ($tree); ?>
							</select>
							&nbsp;&nbsp;
							角色名称
							<select name='f_cstmgrpcstmrl_cstmrlid' id='f_cstmgrpcstmrl_cstmrlidcdt'  class='input-small'>
							<option value=''>无</option>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    <th class='odr'>序号</th>
					    <th class='cstmgrpnm'>团队名称</th>
					    <th class='cstmrlnm'>角色名称</th>
					    <th class='oprt'>操作</th>
					</tr>
					</thead>
					...
					<tbody>
					  ...
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td class='odr'><?php echo ($fstrw+$i); ?></td>
					    ...
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/cstmgrpcstmrlid/<?php echo ($vo['cstmgrpcstmrlid']); ?>">查看</a><?php } ?>
					      <!-- <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/cstmgrpcstmrlid/<?php echo ($vo['cstmgrpcstmrlid']); ?>">修改</a><?php } ?> -->
					      <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['cstmgrpcstmrlid']); ?>)">删除</a><?php } ?>
					    </td>
				...
				<?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/cstmgrpcstmrlid/0" class='btn btn-primary'>添加</a></p><?php } ?>
