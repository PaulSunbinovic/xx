			...
			<div class="panel-body">	
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    <th class='odr'>序号</th>
					    <th class='sysnm'>系统名称</th>
					    <th class='sysip'>系统IP</th>
					    <th class='oprt'>操作</th>
					  </tr>
					</thead>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='sysnm'><?php echo ($vo['sysnm']); ?></td>
					   	<td class='sysip'><?php echo ($vo['sysip']); ?></td>
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/sysid/<?php echo ($vo['sysid']); ?>">查看</a><?php } ?>
					      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/sysid/<?php echo ($vo['sysid']); ?>">修改</a><?php } ?> 
					      <!-- <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['sysid']); ?>)">删除</a><?php } ?>  -->
					    </td>
				...
				<!-- <?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/sysid/0">添加</a></p><?php } ?> -->
