	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">	
					...
					<table class='tb'>
					<tr><td>用户名：</td><td><input type='text' name='usrnm' value="<?php echo ($mo['usrnm']); ?>" id='usrnm' class='form-control input-sm' readonly/></td></tr>
					<tr><td>真实姓名：</td><td><input type='text' name='usrnn' value="<?php echo ($mo['usrnn']); ?>" id='usrnn' class='form-control input-sm'/></td></tr>
					<tr><td>站点名称：</td><td>
						<select name='f_usr_sttid' class='form-control input-sm' disabled>
					...
					<input type='button' id='usr_modify' value=<?php echo ($btnvl); ?> class='btn btn-primary' />
					</form>
		 </div>
