...
<div class='container' >
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class='tb'>
					<tr><td>年级：</td><td><?php echo ($mo['grdnm']); ?></td></tr>
					<tr><td>站点：</td><td><?php echo ($mo['sttnm']); ?></td></tr>
					<tr><td>班主任姓名：</td><td><?php echo ($mo['usrnn']); ?></td></tr>
					<tr><td>班级名称：</td><td><?php echo ($mo['clsnm']); ?></td></tr>
					<tr><td>班级激活状况：</td><td><?php echo ($mo['clsactvt']); ?></td></tr>
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/bzrid/<?php echo ($mo['bzrid']); ?>/grdid/<?php echo ($mo['f_bzr_grdid']); ?>"  class='btn btn-primary'>前往修改信息</a><?php } ?>
  ...
  <div class="container">				
		<p>Designed by <a href="#" target="_blank">sunbinovic@163.com</a></p>&copy; 2012-<?php echo date('Y',time()); ?> 中国计量学院成人教育学院、继续教育学院 </p>
	</div> <!-- /container -->
</footer>
