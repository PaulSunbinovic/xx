	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
			...
			<div class="panel-body">					
				...
				<form>
				<input type='hidden' name='mdid' value="<?php echo ($mo['mdid']); ?>" />
				<table class='tb'>
				<tr><td>模块标识：</td><td><input type='text' name='mdmk' value="<?php echo ($mo['mdmk']); ?>" id='mdmk' class='form-control input-sm'/></td></tr>
				<tr><td>模块姓名：</td><td><input type='text' name='mdnm' value="<?php echo ($mo['mdnm']); ?>" id='mdnm' class='form-control input-sm'/></td></tr>
				</table>
