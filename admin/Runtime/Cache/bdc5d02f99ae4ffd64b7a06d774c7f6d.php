...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='grprlid' value="<?php echo ($mo['grprlid']); ?>" />
				<table class='tb'>
				
				<tr><td>团队名称</td>
				<td>
				<select name='f_grprl_grpid' class='form-control input-sm'>
					<option value='0'>无</option>
					<?php echo ($tree); ?>
				</select>
				<script>$('select[name=f_grprl_grpid]').val(<?php echo ($mo['f_grprl_grpid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>角色名称</td>
				<td>
				<select name='f_grprl_rlid' class='form-control input-sm'>
					<option value='0'>无</option>
				...
				<script>$('select[name=f_grprl_rlid]').val(<?php echo ($mo['f_grprl_rlid']); ?>)</script>
				</td>
				</tr>
