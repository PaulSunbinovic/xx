	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
				<form>
				<input type='hidden' name='xqid' value="<?php echo ($mo['xqid']); ?>" />
				<table class='tb'>
				<tr><td>学期名称：</td><td><input type='text' name='xqnm' value="<?php echo ($mo['xqnm']); ?>" id='xqnm'/></td></tr>
				<tr><td>是否当前学期：</td><td>
				<select name='xqdq'>
					<option value='1'>是</option>
					<option value='0'>否</option>
				</select>
				<script>$('select[name=xqdq]').val(<?php echo ($mo['xqdq']); ?>);</script>
				</td></tr>
				</table>
