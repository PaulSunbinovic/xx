	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			...
			<div class="panel-body">				
				...
				<tr><td>课程名称：</td><td><?php echo ($mo['kcnm']); ?></td></tr>
				<tr><td>课程是否通识：</td><td><?php echo ($mo['kcsfts']); ?></td></tr>
				
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/kcid/<?php echo ($mo['kcid']); ?>/grdid/<?php echo ($mo['f_kc_grdid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
