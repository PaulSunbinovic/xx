	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			...
			<div class="panel-body">				
				...
				<table class='tb'>
				<tr><td>学年名称：</td><td><?php echo ($mo['xnnm']); ?></td></tr>
				<tr><td>是否当前学年：</td><td><?php echo ($mo['xndq']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/xnid/<?php echo ($mo['xnid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
