	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<tr><td>开设办学形式：</td><td><?php echo ($mo['zsszbxxsu']); ?></td></tr>
				<tr><td>是否开启招生：</td><td><?php echo ($mo['zsszop']); ?></td></tr>
				<tr><td>招生截至时间：</td><td><?php echo ($mo['zsszjztm']); ?></td></tr>
				<tr><td>招生小年龄时间：</td><td><?php echo ($mo['zsszxnltm']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/zsszid/<?php echo ($mo['zsszid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
