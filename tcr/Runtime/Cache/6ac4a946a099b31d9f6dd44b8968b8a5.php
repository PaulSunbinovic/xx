	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
		  ...
		  <div class="panel-body" style='min-height:500px'>				
					<form>
					<input type='hidden' name='tcrid' value="<?php echo ($mo['tcrid']); ?>" />
					<table class='tb'>
					<tr><td>帐号：</td><td><input type='text' name='tcrnm' value="<?php echo ($mo['tcrnm']); ?>" id='tcrnm' class='form-control input-sm' readonly/></td></tr>
					<tr><td>姓名：</td><td><input type='text' name='tcrnn' value="<?php echo ($mo['tcrnn']); ?>" id='tcrnn' class='form-control input-sm'/></td></tr>
					<tr><td>站点名称：</td><td>
						<!-- <select name='f_tcr_sttid' class='form-control input-sm' onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;"> -->
						<select name='f_tcr_sttid' class='form-control input-sm' disabled>
					...
					var hdlupload='__APP__/FileUpload/upload/issml/y/wjj/tcr';
					...
					<tr><td>教师办公室：</td><td><input type='text' name='tcrads' value="<?php echo ($mo['tcrads']); ?>" id='tcrads' class='form-control input-sm'/></td></tr>
					...
					<input type='button' id='tcr_modify' value=<?php echo ($btnvl); ?> class='btn btn-success' />
					</form>
		  </div>
		</div>
	</div>
