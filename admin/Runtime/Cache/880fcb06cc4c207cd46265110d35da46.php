		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>办学形式：</td><td><?php echo ($mo['bxxsnm']); ?></td></tr>
					<tr><td>层次：</td><td><?php echo ($mo['ccnm']); ?></td></tr>
					<tr><td>科类：</td><td><?php echo ($mo['klnm']); ?></td></tr>
					<tr><td>学费数目：</td><td><?php echo ($mo['xfsm']); ?></td></tr>
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/xfid/<?php echo ($mo['xfid']); ?>/grdid/<?php echo ($mo['f_xf_grdid']); ?>"  class='btn btn-primary'>前往修改信息</a><?php } ?>
