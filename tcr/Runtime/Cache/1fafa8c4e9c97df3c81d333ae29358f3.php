	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
		  ...
		  <div class="panel-body" style='min-height:500px'>				
					...
					<table class='tb'>
					<tr><td>原密码：</td><td><input type='password' name='tcrpworg' class='form-control input-sm'/></td></tr>
					<tr><td>新密码：</td><td><input type='password' name='tcrpwnew' class='form-control input-sm'/></td></tr>
					<tr><td>再输入一次新密码：</td><td><input type='password' name='tcrpwnewag' class='form-control input-sm'/></td></tr>
					</table>
					
					<input type='button' id='tcr_modifypw' value=<?php echo ($btnvl); ?> class='btn btn-success' />
					</form>
		  </div>
		</div>
	</div>
