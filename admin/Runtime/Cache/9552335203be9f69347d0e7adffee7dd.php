...
<link rel="stylesheet" href="__PUBLIC__/CSS/admin/pk.css"/>
	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						<input type='hidden' name='pkid' id='pkid' value="<?php echo ($mo['pkid']); ?>" />
						...
						<script>$('select[name=f_pk_sttid]').val(<?php echo ($mo['f_pk_sttid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<script>$('select[name=f_pk_grdid]').val(<?php echo ($mo['f_pk_grdid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<script>$('select[name=f_pk_xqid]').val(<?php echo ($mo['f_pk_xqid']); ?>)</script>
						</td>
						...
						<script>$('select[name=f_pk_kcid]').val(<?php echo ($mo['f_pk_kcid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<script>$('select[name=f_pk_tcrid]').val(<?php echo ($mo['f_pk_tcrid']); ?>)</script>
						</td>
						</tr>
						...
						<td>
						<input type='text' name='pkwqm' value="<?php echo ($mo['pkwqm']); ?>">
						</td>
						</tr>
						...
						<td>
						<input type='text' name='pkwps' value="<?php echo ($mo['pkwps']); ?>">
						</td>
						</tr>
						...
						<td>
						<input type='text' name='pkwxt' value="<?php echo ($mo['pkwxt']); ?>">
						</td>
						</tr>
						...
						<script>$('select[name=pkzkkm]').val(<?php echo ($mo['pkzkkm']); ?>)</script>
						</td>
						</tr>
