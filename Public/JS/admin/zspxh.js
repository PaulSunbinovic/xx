...
//		}
	...
	$('#fadeschq').click(function(){
		if(confirm('生成EXCEL成功后需要对照EXCEL进行文件夹操作，并于当天上传')){
			$('#trueschq').trigger('click');
		}
	})
