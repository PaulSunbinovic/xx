			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						...
						<tr>
						<td>应缴学费（含报名费）：</td><td><input name='cwyjxfsm' value="<?php echo ($mo['cwyjxfsm']); ?>" alt="<?php echo ($mo['cwyjxfsm']); ?>" /></td><td>实缴学费（含报名费）：</td><td><input name='cwsjxfsm' value="<?php echo ($mo['cwsjxfsm']); ?>" alt="<?php echo ($mo['cwsjxfsm']); ?>" /></td>
						</tr>
						<tr>
