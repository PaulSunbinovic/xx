		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>站点：</td><td><?php echo ($mo['kcnm']); ?></td></tr>
					<tr><td>学期：</td><td><?php echo ($mo['zynm']); ?></td></tr>
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/kczyid/<?php echo ($mo['kczyid']); ?>/grdid/<?php echo ($mo['f_kczy_grdid']); ?>"  class='btn btn-primary'>前往修改信息</a><?php } ?>
