...
var hdlucstmrl='__URL__/update';var hdlcstmgrptocstmrl='__URL__/cstmgrptocstmrl';
</script>
</head>
...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='cstmusrcstmrlid' value="<?php echo ($mo['cstmusrcstmrlid']); ?>" />
				<table class='tb'>
				
				<tr><td>用户名</td>
				<td>
				<select name='f_cstmusrcstmrl_cstmusrid' class='form-control input-sm'>
					<option value='0'>无</option>
					<?php if(is_array($uscstmrls)): $i = 0; $__LIST__ = $uscstmrls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cstmusrid']); ?>"><?php echo ($vo['cstmusrnm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				<script>$('select[name=f_cstmusrcstmrl_cstmusrid]').val(<?php echo ($mo['f_cstmusrcstmrl_cstmusrid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>客户团队名称</td>
				<td>
				<select name='cstmgrpid' id='cstmgrpid' class='form-control input-sm'>
					<option value='0'>无</option>
					<?php echo ($tree); ?>
				</select>
				<script>$('select[name=cstmgrpid]').val(<?php echo ($mo['cstmgrpid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>客户角色名称</td>
				<td>
				<select name='f_cstmusrcstmrl_cstmrlid' id='f_cstmusrcstmrl_cstmrlid' class='form-control input-sm'>
					<option value='0'>无</option>
				...
				<script>$('select[name=f_cstmusrcstmrl_cstmrlid]').val(<?php echo ($mo['f_cstmusrcstmrl_cstmrlid']); ?>)</script>
				</td>
				</tr>
