	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-success">
		  ...
		  <div class="panel-body" style='min-height:500px'>				
					<h1>教师端  <small>后台管理</small></h1>
					<ul class="list-unstyled col-md-10" style='margin-top:40px'>
					<?php if(is_array($atcls)): $i = 0; $__LIST__ = $atcls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span class='pull-left'><a href="__APP__/Atc/view/atcid/<?php echo ($vo['atcid']); ?>"  style="color:#3c763d; font-size:20px"> 《<?php echo ($vo['atctpc']); ?>》</a></span><span class='tag pull-right' style='color:#ccc;padding-top:5px'><?php echo ($vo['atcmdftm']); ?></span></li>
