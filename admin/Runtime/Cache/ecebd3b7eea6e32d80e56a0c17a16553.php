	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			...
			<div class="panel-body">				
				...
				<table class='tb'>
				<tr><td>学期名称：</td><td><?php echo ($mo['xqnm']); ?></td></tr>
				<tr><td>是否当前学期：</td><td><?php echo ($mo['xqdq']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/xqid/<?php echo ($mo['xqid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
