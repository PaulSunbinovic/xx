		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type='hidden' name='cjzxid' value="<?php echo ($mo['cjzxid']); ?>" />
					<table class='tb'>
					<tr>
					<td>
					...
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grdid/<?php echo ($mo['f_cjzx_grdid']); ?>/cjzxid/<?php echo ($mo['cjzxid']); ?>"  class='btn btn-warning'>前往修改信息</a><?php } ?>
