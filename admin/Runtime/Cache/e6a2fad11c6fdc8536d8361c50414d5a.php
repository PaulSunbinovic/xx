		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class='tb'>
					<tr><td>微信appid：</td><td><?php echo ($mo['wxappid']); ?></td></tr>
					<tr><td>微信secret：</td><td><?php echo ($mo['wxscrt']); ?></td></tr>
					<tr><td>微信ip：</td><td><?php echo ($mo['wxip']); ?></td></tr>
					<tr><td>微信二维码：</td><td>
					<img src="<?php echo ($mo['wxqr']); ?>" alt=""  class='img-thumbnail'  style="width:100px;" />
					</td></tr>
					<tr><td>微信功能是否打开：</td><td><?php echo ($mo['wxop']); ?></td></tr>
					
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/wxid/<?php echo ($mo['wxid']); ?>"  class='btn btn-primary'>前往修改信息</a><?php } ?>
