	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
					<input type='hidden' name='usrid' id='usrid' value="<?php echo ($mo['usrid']); ?>" />
					<table class='tb'>
					<tr><td>用户名：</td><td><input type='text' name='usrnm' value="<?php echo ($mo['usrnm']); ?>" id='usrnm' class='form-control input-sm' <?php echo ($nmrdol); ?>/></td></tr>
					<?php if($mo['usrid']==0){ ?>
					...
					<tr><td>密码：</td><td><input type='text' name='usrpw' value="<?php echo ($mo['usrpw']); ?>" id='usrpw' class='form-control input-sm'/></td></tr>
					<tr><td>再输入一次密码：</td><td><input type='text' name='usrpwag' value="<?php echo ($mo['usrpw']); ?>" id='usrpwag' class='form-control input-sm'/></td></tr>
					<script> 
					...
					<tr><td></td><td><input type='button' class='btn btn-warning' onclick="rstpw(<?php echo ($mo['usrid']); ?>)" value="重置密码" /></td></tr>
					<?php } ?>
					<tr><td>真实姓名：</td><td><input type='text' name='usrnn' value="<?php echo ($mo['usrnn']); ?>" id='usrnn' class='form-control input-sm'/></td></tr>
					...
					var hdlupload='__APP__/FileUpload/upload/issml/y/wjj/usr';////注意
					...
					<tr><td>用户地址：</td><td><input type='text' name='usrads' value="<?php echo ($mo['usrads']); ?>" id='usrads' class='form-control input-sm'/></td></tr>
					<tr><td>用户固话：</td><td><input type='text' name='usrtlp' value="<?php echo ($mo['usrtlp']); ?>" id='usrtlp' class='form-control input-sm'/></td></tr>
					
					<tr><td>手机号：</td><td><input type='text' name='usrcp' value="<?php echo ($mo['usrcp']); ?>" id='usrcp' class='form-control input-sm'/></td></tr>
					<tr><td>密保邮箱：</td><td><input type='text' name='usrml' value="<?php echo ($mo['usrml']); ?>" id='usrml' class='form-control input-sm'/></td></tr>
					...
					<tr><td>用户排序：</td><td><input type='text' name='usrodr' value="<?php echo ($mo['usrodr']); ?>" id='usrodr' class='form-control input-sm'/></td></tr>
					<tr><td>审核情况：</td>
					<td>
					<select name='usrps' class='form-control input-sm'>
						<option value='1'>通过</option>
						<option value='0'>未通过</option>
					</select>
					<script>$('select[name=usrps]').val("<?php echo ($mo['usrps']); ?>");</script>
					</td>
					</tr>
					<tr><td>查看情况：</td>
					<td>
					<select name='usrvw' class='form-control input-sm'>
						<option value='1'>看过</option>
						<option value='0'>未看过</option>
					</select>
					<script>$('select[name=usrvw]').val("<?php echo ($mo['usrvw']); ?>");</script>
					</td>
					</tr>
					</table>
