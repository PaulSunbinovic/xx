...
<link rel="stylesheet" href="__PUBLIC__/CSS/std/std.css"/> 
<script type='text/javascript' src='__PUBLIC__/JS/std/std.js'></script>
...
<div class='container' >
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		<script>
		var hdlstdbtn='__APP__/Tcrbtn/update';
		</script>
			 ...
			 <div class="panel panel-info">
				...
				<!-- List group -->
				  <ul class="nav nav-pills nav-stacked" style="display:<?php echo ($bsbdcls); ?>" id="bsbd">
						...
						<li class=""><a href="__APP__/Cjzx/cxcj" class='<?php echo ($cxcjcls); ?>'>查询成绩</a></li>
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-info">
		  ...
		  <div class="panel-body" style='min-height:500px'>				
				...
				<td>班级：</td><td><?php echo ($mo['clsnm']); ?></td>
				</tr>
				</table>
				</div>
