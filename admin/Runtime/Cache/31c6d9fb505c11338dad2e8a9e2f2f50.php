...
<script type='text/javascript' src='__PUBLIC__/JS/admin/cstmgrp.js'></script>
<script type='text/javascript'>
var hdlurl='__URL__/update';
var jmpurl='__URL__/query';
</script>
</head>
...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='cstmgrpid' value="<?php echo ($mo['cstmgrpid']); ?>" />
				<table class='tb'>
				<tr><td>客户团队名：</td><td><input type='text' name='cstmgrpnm' value="<?php echo ($mo['cstmgrpnm']); ?>" id='cstmgrpnm' class='form-control input-sm'/></td></tr>
				</table>
				<input type='hidden' name='cstmgrppid' value="<?php echo ($mo['cstmgrppid']); ?>" />
				<input type='hidden' name='cstmgrpodr' value="<?php echo ($mo['cstmgrpodr']); ?>" />
