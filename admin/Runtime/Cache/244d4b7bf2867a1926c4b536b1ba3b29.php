		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type='hidden' name='pkid' value="<?php echo ($mo['pkid']); ?>" />
					<table class='tb'>
					<tr>
					<td>
					...
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grdid/<?php echo ($mo['f_pk_grdid']); ?>/pkid/<?php echo ($mo['pkid']); ?>"  class='btn btn-warning'>前往修改信息</a><?php } ?>
