...
$(function () {
	...
	var zsjxsg=$('#zsjxsgfld');
	var zsjxtz=$('#zsjxtzfld');
	var zsjxxm=$('#zsjxxmfld');
	
	var cwyjxfsm=$('#cwyjxfsmfld');
	var cwyjjckwfsm=$('#cwyjjckwfsmfld');
	var cwyjzsfsm=$('#cwyjzsfsmfld');

	var cwsjxfsm=$('#cwsjxfsmfld');
	var cwsjjckwfsm=$('#cwsjjckwfsmfld');
	var cwsjzsfsm=$('#cwsjzsfsmfld');

	var dftxlsnm=$('input[name=xlsnm]').val();
	...
	f_stdxqcls_clsid.change(function(){
		...
		jsn={f_stdxqcls_clsid:f_stdxqcls_clsid.val(),f_std_grdid:f_std_grdid.val()};
		$.post(
			hdlclswithstdno,
			jsn,
			function(data){
				if(data.status==1){
					...
					$('input[name=xlsnm]').val(data.clsnm+dftxlsnm);
	...
	zsjxsg.click(function(){
		if(zsjxsg.prop('checked')==true){
			zsjxtz.prop('checked',true);
			zsjxxm.prop('checked',true);
		}else{
			zsjxtz.prop('checked',false);
			zsjxxm.prop('checked',false);
		}
		
	});

	cwyjxfsm.click(function(){
		if(cwyjxfsm.prop('checked')==true){
			cwyjjckwfsm.prop('checked',true);
			cwyjzsfsm.prop('checked',true);
			cwsjxfsm.prop('checked',true);
			cwsjjckwfsm.prop('checked',true);
			cwsjzsfsm.prop('checked',true);
		}else{
			cwyjjckwfsm.prop('checked',false);
			cwyjzsfsm.prop('checked',false);
			cwsjxfsm.prop('checked',false);
			cwsjjckwfsm.prop('checked',false);
			cwsjzsfsm.prop('checked',false);
		}
	...
	$('#glsj').click(function(){
		//先全部清空
		var fldu=$('#flddv').find('input');
		for(var i=0;i<fldu.size();i++){
			fldu[i].checked=false;
		}
		
		$('#stdidfld').prop('checked',true);
		$('#f_std_grdidfld').prop('checked',true);
		$('#f_stdxqcls_xqidfld').prop('checked',true);
		$('#f_stdxqcls_clsidfld').prop('checked',true);
		$('#stdnofld').prop('checked',true);
		$('#stdnmfld').prop('checked',true);
		$('#sexnmfld').prop('checked',true);
		$('#stdbtdfld').prop('checked',true);
		$('#clsnmfld').prop('checked',true);
		$('#mjnmfld').prop('checked',true);
		$('#cwyjxfsmfld').prop('checked',true);
		$('#cwyjjckwfsmfld').prop('checked',true);
		$('#cwyjzsfsmfld').prop('checked',true);
		$('#cwsjxfsmfld').prop('checked',true);
		$('#cwsjjckwfsmfld').prop('checked',true);
		$('#cwsjzsfsmfld').prop('checked',true);
		$('#zsjxsgfld').prop('checked',true);
		$('#zsjxtzfld').prop('checked',true);
		$('#zsjxxmfld').prop('checked',true);
		$('#zspxhschqtmfld').prop('checked',true);
	...
	$('#ckbmsj').click(function(){
		...
		$('#clsnmfld').prop('checked',true);
		$('#mjnmfld').prop('checked',true);
		$('#rcnmfld').prop('checked',true);
		$('#zzmmnmfld').prop('checked',true);
		$('#stdsogfld').prop('checked',true);
		$('#stdidcdfld').prop('checked',true);
		$('#stdadsfld').prop('checked',true);
