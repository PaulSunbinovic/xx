	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<form>
						<input type='hidden' name='zyid' value="<?php echo ($mo['zyid']); ?>" />
						<table class='tb'>
						
											
						<tr><td>年级名称</td>
						<td>
						<select name='f_zy_grdid'>
						...
						<script>$('select[name=f_zy_grdid]').val(<?php echo ($mo['f_zy_grdid']); ?>)</script>
						</td>
						</tr>
						
						<tr><td>大专业名称</td>
						<td>
						<input name='zynm' value="<?php echo ($mo['zynm']); ?>"/>
						...
						<tr><td>大专业代码集</td>
						<td>
						<input name='zydmu' value="<?php echo ($mo['zydmu']); ?>"/>
