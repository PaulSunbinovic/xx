...
<div class="header FixedTop" id='header'>
	...
	<div class="content" id="content">
		<div class='container' style='margin-top:20px'>
			<div class='col-xs-12'>
				<div class='col-xs-6'><img src="<?php echo ($wxoss['wxpt']); ?>" class='img-circle' style='height:80px;width:80px;' /></div>
				<div class='col-xs-6'>
					<div style='height:27px'><?php echo ($wxoss['wxnm']); ?></div>
					<div style='height:27px'><?php echo ($wxoss['wxsex']); ?></div>
					<div style='height:27px'><?php echo ($wxoss['wxct']); ?></div>
				</div>
			</div>
...
<script>var hdllgot='__APP__/Cstmusr/loginout';</script>
