...
//     		if(mb_strlen($atcfcsls[$i]['atctpc'],'utf-8')>20){
//     			$atcfcsls[$i]['atctpcsrk']=mb_substr($atcfcsls[$i]['atctpc'], 0,20,'utf-8').'...';
//     		}else{
...
//    		}
    	...
    	for($i=0;$i<count($bdlsnog);$i++){
    		...
    		for($j=0;$j<count($atcls);$j++){
    			if(mb_strlen($atcls[$j]['atctpc'],'utf-8')>40){
    				$atcls[$j]['atctpcsrk']=mb_substr($atcls[$j]['atctpc'], 0,40,'utf-8').'...';
    			}else{
