		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>起始时间：</td><td><?php echo ($mo['jqqs']); ?></td></tr>
					<tr><td>结束时间：</td><td><?php echo ($mo['jqjs']); ?></td></tr>
					<tr><td>领教材时间：</td><td><?php echo ($mo['jqljc']); ?></td></tr>
					
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/jqid/<?php echo ($mo['jqid']); ?>"  class='btn btn-primary'>前往修改个人信息</a><?php } ?>
