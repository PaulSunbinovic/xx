	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<tr><td>专业代码：</td><td><?php echo ($mo['mjdm']); ?></td></tr>
				<tr><td>专业名称：</td><td><?php echo ($mo['mjnm']); ?></td></tr>
				<tr><td>本部今年是否招生：</td><td><?php echo ($mo['mjbbzs']); ?></td></tr>
				<tr><td>开设站点：</td><td><?php echo ($mo['mjsttu']); ?></td></tr>
				</table>
				简介：
				...
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/mjid/<?php echo ($mo['mjid']); ?>/grdid/<?php echo ($mo['f_mj_grdid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
