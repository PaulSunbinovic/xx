			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						...
						<td colspan=3>
						<?php if($athm!=1){ ?><select name='f_mj_bxxsid' disabled ><?php }else{ ?><select name='f_mj_bxxsid' ><?php } ?>
						...
						<script>$('select[name=f_stdxqdm_xqid]').val(<?php echo ($mo['f_stdxqdm_xqid']); ?>)</script>
						</td>
						...
						<td>专业：</td>
						<td colspan=9>
						<?php if($athm!=1){ ?><select name='f_stdxqmj_mjid' disabled><?php }else{ ?><select name='f_stdxqmj_mjid'><?php } ?>
							<option value='0'>无</option>
						...
						<td>学号：</td><td><?php if($athm!=1){ ?><input type='text' name='stdno' value="<?php echo ($mo['stdno']); ?>" disabled/><?php }else{ ?><input type='text' name='stdno' value="<?php echo ($mo['stdno']); ?>" /><?php } ?></td>
						<td>上传财务时间：</td><td><?php if($aths==1){ ?><script type="text/javascript" src="__PUBLIC__/pblc/DatePicker/My97DatePickerHHmmss/WdatePicker.js"></script><?php } ?><input type="text" name='stdupfnctm' value="<?php echo ($mo['stdupfnctm']); ?>" onclick="WdatePicker()" readonly/></td>
						<td>
						寝室：
						</td>
						<td>
						<?php if($athm!=1){ ?><select name='f_stdxqdm_dmid' disabled><?php }else{ ?><select name='f_stdxqdm_dmid'><?php } ?>
							<option value='0'>无</option>
						...
						<tr>
						<td>姓名：</td><td><?php if($athm!=1){ ?><input type='text' name='stdnm' value="<?php echo ($mo['stdnm']); ?>" id='stdnm' disabled/><?php }else{ ?><input type='text' name='stdnm' value="<?php echo ($mo['stdnm']); ?>" id='stdnm'/><?php } ?></td>
						<td>
						性别：
						</td>
						<td>
						<?php if($athm!=1){ ?><select name='f_std_sexid' disabled><?php }else{ ?><select name='f_std_sexid'><?php } ?>
							<option value='0'>无</option>
						...
						<td>
						<?php if($athm!=1){ ?><select name='f_std_rcid' disabled><?php }else{ ?><select name='f_std_rcid'><?php } ?>
							<option value='0'>无</option>
						...
						<tr>
						<td>身份证号码：</td><td><?php if($athm!=1){ ?><input  type='text' name='stdidcd' value="<?php echo ($mo['stdidcd']); ?>" id='stdidcd' disabled/><?php }else{ ?><input  type='text' name='stdidcd' value="<?php echo ($mo['stdidcd']); ?>" id='stdidcd'/><?php } ?></td>
						...
						<td>状态：</td>
						<td colspan=7>
						<?php if($athm!=1){ ?><select name='f_std_statid' disabled><?php }else{ ?><select name='f_std_statid'><?php } ?>
							<option value='0'>无</option>
