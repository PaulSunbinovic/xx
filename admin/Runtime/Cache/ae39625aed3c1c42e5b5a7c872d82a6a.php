	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
					<input type='hidden' name='cstmusrid' id='cstmusrid' value="<?php echo ($mo['cstmusrid']); ?>" />
					<table class='tb'>
					<tr><td>客户用户名：</td><td><input type='text' name='cstmusrnm' value="<?php echo ($mo['cstmusrnm']); ?>" id='cstmusrnm' class='form-control input-sm' <?php echo ($nmrdol); ?>/></td></tr>
					<?php if($mo['cstmusrid']==0){ ?>
					<tr><td>密码：</td><td><input type='text' name='cstmusrpw' value="<?php echo ($mo['cstmusrpw']); ?>" id='cstmusrpw' class='form-control input-sm'/></td></tr>
					<tr><td>再输入一次密码：</td><td><input type='text' name='cstmusrpwag' value="<?php echo ($mo['cstmusrpw']); ?>" id='cstmusrpwag' class='form-control input-sm'/></td></tr>
					<?php }else{ ?>
					<script>var hdlrstpw='__URL__/resetpassword';</script>
					<tr><td></td><td><input type='button' class='btn btn-warning' onclick="rstpw(<?php echo ($mo['cstmusrid']); ?>)" value="重置密码" /></td></tr>
					<?php } ?>
					...
					var hdlupload='__APP__/FileUpload/upload/issml/y/wjj/cstmusr';////注意
					...
					<script>$('select[name=f_cstmusr_athid]').val(<?php echo ($mo['f_cstmusr_athid']); ?>)</script>
					</td>
					</tr>
					...
					<tr><td>审核情况：</td>
					<td>
					<select name='cstmusrps' class='form-control input-sm'>
					...
					<input type='hidden' name='cstmusrvw' value="<?php echo ($mo['cstmusrvw']); ?>" />
