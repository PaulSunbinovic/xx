							  ...
							  <div class="tab-content">
							    <div role="tabpanel" class="tab-pane" id="home">
							    	<div id='flddv'>
										...
										<input type="checkbox" id='stdbtdfld' value='stdbtd'/>生日&nbsp;&nbsp;
				...
				<div class="table-responsive">
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='oprt'>
						      <!-- Icons -->
						      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/grdid/<?php echo ($vo['f_std_grdid']); ?>/xqid/<?php echo ($vo['f_stdxqcls_xqid']); ?>/stdid/<?php echo ($vo['stdid']); ?>">查看</a><?php } ?>
						      <?php if($vo['mdf']==1){ ?><a href="__URL__/gtxpg/x/mdf/grdid/<?php echo ($vo['f_std_grdid']); ?>/xqid/<?php echo ($vo['f_stdxqcls_xqid']); ?>/stdid/<?php echo ($vo['stdid']); ?>">更改基本信息</a><?php } ?> 
						      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grdid/<?php echo ($vo['f_std_grdid']); ?>/xqid/<?php echo ($vo['f_stdxqcls_xqid']); ?>/stdid/<?php echo ($vo['stdid']); ?>">修改</a><?php } ?> 
