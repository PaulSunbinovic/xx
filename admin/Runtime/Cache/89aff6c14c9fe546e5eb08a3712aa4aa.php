	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
				<form>
				<input type='hidden' name='xnid' value="<?php echo ($mo['xnid']); ?>" />
				<table class='tb'>
				<tr><td>学年名称：</td><td><input type='text' name='xnnm' value="<?php echo ($mo['xnnm']); ?>" id='xnnm'/></td></tr>
				<tr><td>是否当前学年：</td><td>
				<select name='xndq'>
					<option value='1'>是</option>
					<option value='0'>否</option>
				</select>
				<script>$('select[name=xndq]').val(<?php echo ($mo['xndq']); ?>);</script>
				</td></tr>
				</table>
