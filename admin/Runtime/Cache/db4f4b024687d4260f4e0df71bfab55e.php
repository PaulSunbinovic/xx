...
<script type='text/javascript' src='__PUBLIC__/JS/admin/sttintxq.js'></script>
	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<!-- NB 开始 -->
				    ...
				    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
				      ...
				      <!-- 暂时结束 -->
						<div id='flddv'>
							字段：<!-- uid必须有且不用看见 -->
							<input type="checkbox" id='sttintxqidfld' value='sttintxqid' style='display:none' checked=checked/>
							<input type="checkbox" id='f_sttintxq_grdidfld' value='f_sttintxq_grdid' style='display:none' checked=checked/>
							<input type="checkbox" id='grdnmfld' value='grdnm'/>年级&nbsp;&nbsp;
							<input type="checkbox" id='sttnmfld' value='sttnm'/>站点&nbsp;&nbsp;
							<input type="checkbox" id='xqnmfld' value='xqnm'/>学期&nbsp;&nbsp;
							<input type="checkbox" id='sttintxqyesfld' value='sttintxqyes'/>是否一二三&nbsp;&nbsp;
							
						</div>
						<div id='cdtdv'>
							条件：
							年级
							<select name='f_sttintxq_grdid' id='f_sttintxq_grdidcdt' >
							...
							&nbsp;&nbsp;
							站点
							<select name='f_sttintxq_sttid' id='f_sttintxq_sttidcdt' >
							<option value=''>无</option>
							...
							&nbsp;&nbsp;
							学期
							<select name='f_sttintxq_xqid' id='f_sttintxq_xqidcdt' >
							<option value=''>无</option>
							<?php if(is_array($xqls)): $i = 0; $__LIST__ = $xqls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$volII): $mod = ($i % 2 );++$i;?><option value="<?php echo ($volII['xqid']); ?>"><?php echo ($volII['xqnm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
							&nbsp;&nbsp;
							是否用一二三学期
							<select name='sttintxqyes' id='sttintxqyescdt' >
							<option value=''>无</option>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='xqnm'>学期</th>
					    <th class='sttintxqyes'>是否一二三学期</th>
					    <th class='oprt'>操作</th>
					  </tr>
					</thead>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='sttintxqyes'><?php echo ($vo['sttintxqyes']); ?></td>
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/sttintxqid/<?php echo ($vo['sttintxqid']); ?>/grdid/<?php echo ($vo['f_sttintxq_grdid']); ?>">查看</a><?php } ?>
					      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/sttintxqid/<?php echo ($vo['sttintxqid']); ?>/grdid/<?php echo ($vo['f_sttintxq_grdid']); ?>">修改</a><?php } ?> 
					      <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['sttintxqid']); ?>)">删除</a><?php } ?>
				...
				<?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/sttintxqid/0" class='btn btn-primary'>添加</a></p><?php } ?>
