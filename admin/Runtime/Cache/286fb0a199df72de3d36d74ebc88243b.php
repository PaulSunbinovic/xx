...
<script type='text/javascript' src='__PUBLIC__/JS/admin/zsyx.js'></script>
	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				    ...
				    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
				      ...
				      <!-- 暂时结束 -->
							  ...
							  <div class="tab-content">
							    <div role="tabpanel" class="tab-pane" id="home">
							    	<div id='flddv'>
										...
										<input type="checkbox" id='cwyjxfsmfld'  value='cwyjxfsm' />财务信息&nbsp;&nbsp;
										<input type="checkbox" id='cwyjjckwfsmfld'  value='cwyjjckwfsm' style='display: none'/>
										<input type="checkbox" id='cwyjzsfsmfld'  value='cwyjzsfsm' style='display: none'/>
										<input type="checkbox" id='cwsjxfsmfld'  value='cwsjxfsm' style='display: none'/>
										<input type="checkbox" id='cwsjjckwfsmfld'  value='cwsjjckwfsm' style='display: none'/>
										<input type="checkbox" id='cwsjzsfsmfld'  value='cwsjzsfsm' style='display: none'/>
										<input type="checkbox" id='stdbtdfld' value='stdbtd'/>小年龄情况&nbsp;&nbsp;
										<input type="checkbox" id='zsjxsgfld' value='zsjxsg'/>军训信息&nbsp;&nbsp;
										<input type="checkbox" id='zsjxtzfld' value='zsjxtz' style='display:none'/>
										<input type="checkbox" id='zsjxxmfld' value='zsjxxm' style='display:none'/>
										<input type="checkbox" id='zspxhschqtmfld' value='zspxhschqtm'/>饭卡情况&nbsp;&nbsp;
									</div>
								</div>
							    <div role="tabpanel" class="tab-pane active" id="profile">
									...
									<br><a class='spccdtoff' style='cursor:pointer' rel="(stdbtd<'<?php echo ($zsszo[zsszxnltm]); ?>')">筛选出大年龄（标准<?php echo ($zsszo['zsszxnltm']); ?>以后出生为小年龄）</a>
									<br><br><a class='spccdtoff' style='cursor:pointer' rel="(stdbtd>='<?php echo ($zsszo[zsszxnltm]); ?>')">筛选出小年龄（标准<?php echo ($zsszo['zsszxnltm']); ?>以后出生为小年龄）</a>
									<a class='spccdtoff' style='cursor:pointer;display:none' rel="(stdupfnctm<>'' AND f_std_statid=1)">筛选出拟录取学生（用于打印缴费通知书）</a>
									<a class='spccdtoff' style='cursor:pointer;display:none' rel="(f_std_statid<>9)" >（排除了不来的学生）</a>
						...
						<div>
							...
							<br><br>
							<input type='button' value='查询' id='NBsrcU' class='btn btn-primary btn-lg'/>
							</form>
						</div>

						<div style='padding-top:20px'>
							<input type='button' class='btn btn-success btn-lg' id='glsj' value='概览视角'>
							<input type='button' class='btn btn-success btn-lg' id='xnlsj' value='小年龄视角'>
							<input type='button' class='btn btn-success btn-lg' id='cwsj' value='财务视角'>
							<input type='button' class='btn btn-success btn-lg' id='jxsj' value='军训视角'>
							<input type='button' class='btn btn-danger btn-lg' id='ckbmsj' value='成考报名视角'>
						</div>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='stdbtd'>出生日期</th>
					    <th class='stdbtd'>是否小年龄</th>
					    ...
					    <th class='zsjxsg'>身高</th>
					    <th class='zsjxtz'>体重</th>
					    <th class='zsjxxm'>鞋码</th>
					    <th class='zspxhschqtm'>饭卡</th>
					    <th class='cwyjzsfsm'>应缴费</th>
					    <th class='cwyjzsfsm'>实缴费</th>
					    <th class='cwyjzsfsm'>缴费情况</th>
					    <th class='oprt'>操作</th>
					  </tr>
					</thead>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='stdbtd'><?php echo ($vo['xnl']); ?></td>
						    ...
						    <td class='zspxhschqtm'><?php echo ($vo['zspxhschqtm']); ?></td>
						    <td class='cwyjzsfsm'><?php echo ($vo['yjfsm']); ?></td>
						    <td class='cwyjzsfsm'><?php echo ($vo['sjfsm']); ?></td>
						    <td class='cwyjzsfsm'><?php echo ($vo['cwstat']); ?></td>
						    <td class='oprt'>
						      <!-- Icons -->
				...
				<form action='__APP__/Xls/zsyxmd' method='post'>
				...
				请命名表的名称:<input type='text' name='xlsnm' value='新生信息表' class='form-control input-sm' style='width:200px;display:inline'/>
				<br/><input type='button' id='export' value='导出数据' class='btn btn-success btn-lg'/><input type='submit' id='exporttrue' style='display:none' value='导出数据' />
				</form>
				<br><br><br>
				<!--
