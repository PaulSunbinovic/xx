	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<tr><td>时间：</td><td><?php echo ($mo['cstmcmttm']); ?></td></tr>
				<tr><td>内容：</td><td><?php echo ($mo['cstmcmtctt']); ?></td></tr>
				<tr><td>赞：</td><td><?php echo ($mo['cstmcmtzn']); ?></td></tr>
				<tr><td>吐槽：</td><td><?php echo ($mo['cstmcmttc']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/cstmcmtid/<?php echo ($mo['cstmcmtid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
