	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='cjzxqmf'>卷面成绩</th>
					    <th class='cjzxpsf'>平时成绩</th>
					    <th class='cjzxxtf'>习题成绩</th>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='cjzxqmf'><?php if($athm==1&&$vo['cjzxxk']=='否'&&$vo['cjzxhk']=='否'){ ?><input class='cj' name="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" id="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxqmf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" id="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxqmf']); ?>" readonly  style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?></td>
						    <td class='cjzxpsf'><?php if($vo['czps']==1&&$vo['cjzxxk']=='否'&&$vo['cjzxhk']=='否'){ ?><input class='cj' name="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" id="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxpsf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" id="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxpsf']); ?>" readonly  style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?></td>
						    <td class='cjzxxtf'><?php if($athm==1&&$vo['cjzxxk']=='否'&&$vo['cjzxhk']=='否'){ ?><input class='cj' name="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" id="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxxtf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" id="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxxtf']); ?>" readonly  style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?></td>
						    ...
						    <td class='oprt'>
						      <!-- Icons -->
						      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/grdid/<?php echo ($vo['f_cjzx_grdid']); ?>/cjzxid/<?php echo ($vo['cjzxid']); ?>">查看</a><?php } ?>
						      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grdid/<?php echo ($vo['f_cjzx_grdid']); ?>/cjzxid/<?php echo ($vo['cjzxid']); ?>">修改</a><?php } ?> 
						      <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['cjzxid']); ?>,<?php echo ($vo['f_cjzx_grdid']); ?>)">取消选课</a><?php } ?> 
						      <?php if($aths==1){ ?><a href="javascript:stxk(<?php echo ($vo['cjzxid']); ?>,<?php echo ($vo['f_cjzx_grdid']); ?>)"><?php echo ($vo['xkstr']); ?></a><?php } ?>
						      <?php if($aths==1){ ?><a href="javascript:sthk(<?php echo ($vo['cjzxid']); ?>,<?php echo ($vo['f_cjzx_grdid']); ?>)"><?php echo ($vo['hkstr']); ?></a><?php } ?> 	
						    </td>
				...
				<br/><br/><input type='button' id='exportbjcj' value='生成成绩单' class='btn btn-primary btn-lg' /><input type='submit' id='exporttrue' style='display:none' value='导出数据' />
				<br/><br/><input type='button' id='exportbjqd' value='生成签到单' class='btn btn-success btn-lg' />
				<br/><br/><input type='button' id='exportbjkb' value='生成空白单' class='btn btn-warning btn-lg' />
				</form>
