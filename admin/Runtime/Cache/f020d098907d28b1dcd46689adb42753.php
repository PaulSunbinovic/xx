	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<tr><td>站点单位：</td><td><?php echo ($mo['sttcprt']); ?></td></tr>
				<tr><td>站点地址：</td><td><?php echo ($mo['sttads']); ?></td></tr>
				<tr><td>站点负责人姓名：</td><td><?php echo ($mo['sttrspnm']); ?></td></tr>
				<tr><td>站点负责人固话：</td><td><?php echo ($mo['sttrsptlp']); ?></td></tr>
				<tr><td>站点负责人手机号：</td><td><?php echo ($mo['sttrspcp']); ?></td></tr>
				<tr><td>站点激活情况：</td><td><?php echo ($mo['sttactvt']); ?></td></tr>
				...
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/sttid/<?php echo ($mo['sttid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
