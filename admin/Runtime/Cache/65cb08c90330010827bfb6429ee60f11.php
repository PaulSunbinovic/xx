			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type='hidden' name='tcrid' value="<?php echo ($mo['tcrid']); ?>" />
					 审核情况：
					<select name='tcrps' class='form-control input-sm' style='display:inline;width:100px'>
					...
					<tr><td>教师地址：</td><td><?php echo ($mo['tcrads']); ?></td></tr>
					<tr><td>教师座机：</td><td><?php echo ($mo['tcrtlp']); ?></td></tr>
					<tr><td>手机号：</td><td><?php echo ($mo['tcrcp']); ?></td></tr>
					<tr><td>密保邮箱：</td><td><?php echo ($mo['tcrml']); ?></td></tr>
					<tr><td>教师简介：</td><td><div style='width:700px'><?php echo ($mo['tcrintr']); ?></div></td></tr>
				
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/tcrid/<?php echo ($mo['tcrid']); ?>"  class='btn btn-primary'>前往修改个人信息</a><?php } ?>
