...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='cstmgrpcstmrlid' value="<?php echo ($mo['cstmgrpcstmrlid']); ?>" />
				<table class='tb'>
				
				<tr><td>团队名称</td>
				<td>
				<select name='f_cstmgrpcstmrl_cstmgrpid' class='form-control input-sm'>
					<option value='0'>无</option>
					<?php echo ($tree); ?>
				</select>
				<script>$('select[name=f_cstmgrpcstmrl_cstmgrpid]').val(<?php echo ($mo['f_cstmgrpcstmrl_cstmgrpid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>角色名称</td>
				<td>
				<select name='f_cstmgrpcstmrl_cstmrlid' class='form-control input-sm'>
					<option value='0'>无</option>
				...
				<script>$('select[name=f_cstmgrpcstmrl_cstmrlid]').val(<?php echo ($mo['f_cstmgrpcstmrl_cstmrlid']); ?>)</script>
				</td>
				</tr>
