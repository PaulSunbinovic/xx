	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<tr><td>客户团队名称：</td><td><?php echo ($mo['cstmgrpnm']); ?></td></tr>
				<tr><td>客户角色名称：</td><td><?php echo ($mo['cstmrlnm']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/cstmusrcstmrlid/<?php echo ($mo['cstmusrcstmrlid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
