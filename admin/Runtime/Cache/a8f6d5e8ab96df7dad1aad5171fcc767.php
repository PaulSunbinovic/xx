...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='athid' value="<?php echo ($mo['athid']); ?>" />
				<table class='tb'>
				
				<tr><td>角色名称</td>
				<td>
				<select name='f_ath_rlid' disabled class='form-control input-sm'>
				...
				<script>$('select[name=f_ath_rlid]').val(<?php echo ($mo['f_ath_rlid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>模块名称</td>
				<td>
				<select name='f_ath_mdid' disabled class='form-control input-sm'>
					<option value='0'>无</option>
				...
				<script>$('select[name=f_ath_mdid]').val(<?php echo ($mo['f_ath_mdid']); ?>)</script>
				</td>
				</tr>
				...
				<tr><td>设置</td>
				<td>
				<select name='aths' class='form-control input-sm'>
					<option value='0'>否</option>
					<option value='1'>是</option>
				</select>
				<script>$('select[name=aths]').val("<?php echo ($mo['aths']); ?>")</script>
				</td>
				</tr>
