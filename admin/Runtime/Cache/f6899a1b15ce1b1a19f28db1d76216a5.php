...
var hdlurl='__URL__/update';var hdlcstmgrptocstmrl='__URL__/cstmgrptocstmrl';
</script>
</head>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<select name='f_cstmusrcstmrl_cstmusrid' class='form-control input-sm'>
					...
					<?php if(is_array($cstmusrls)): $i = 0; $__LIST__ = $cstmusrls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cstmusrid']); ?>"><?php echo ($vo['cstmusrnm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
