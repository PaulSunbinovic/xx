...
<link rel="stylesheet" href="__PUBLIC__/pblc/TREE/tree.css" type="text/css" />
<script type='text/javascript' src='__PUBLIC__/pblc/TREE/tree.js'></script>
</head>
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php if($athm==1){ ?><p><a href='__URL__/gtxpg/x/edit' class='btn btn-primary'>进入编辑模式</a></p><?php } ?> 
