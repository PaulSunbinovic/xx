			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type='hidden' name='usrid' value="<?php echo ($mo['usrid']); ?>" />
					 审核情况：
					<select name='usrps' class='form-control input-sm' style='display:inline;width:100px'>
						<option value='0'>未通过</option>
						<option value='1'>通过</option>
					</select>
					<script>$('select[name=usrps]').val("<?php echo ($mo['usrps']); ?>")</script>
					是否浏览
					<select name='usrvw' class='form-control input-sm' style='display:inline;width:100px'>
					...
					<?php } ?>
					<table class='tb'>
					<tr><td>用户名：</td><td><?php echo ($mo['usrnm']); ?></td></tr>
					<tr><td>真实姓名：</td><td><?php echo ($mo['usrnn']); ?></td></tr>
					<tr><td>站点名称：</td><td><?php echo ($mo['sttnm']); ?></td></tr>
					<tr><td>用户头像：</td><td>
					<img src="<?php echo ($mo['usrpt']); ?>" alt=""  class='img-thumbnail'  style="width:100px;" />
					</td></tr>
					<tr><td>创建时间：</td><td><?php echo ($mo['usraddtm']); ?></td></tr>
					<tr><td>修改时间：</td><td><?php echo ($mo['usrmdftm']); ?></td></tr>
					<tr><td>用户地址：</td><td><?php echo ($mo['usrads']); ?></td></tr>
					<tr><td>用户座机：</td><td><?php echo ($mo['usrtlp']); ?></td></tr>
					<tr><td>手机号：</td><td><?php echo ($mo['usrcp']); ?></td></tr>
					<tr><td>密保邮箱：</td><td><?php echo ($mo['usrml']); ?></td></tr>
					<tr><td>用户简介：</td><td><div style='width:700px'><?php echo ($mo['usrintr']); ?></div></td></tr>
				
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/usrid/<?php echo ($mo['usrid']); ?>"  class='btn btn-primary'>前往修改个人信息</a><?php } ?>
