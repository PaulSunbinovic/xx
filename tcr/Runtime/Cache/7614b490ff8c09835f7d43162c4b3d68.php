...
<script type='text/javascript' src='__PUBLIC__/JS/tcr/cjzx.js'></script>
		...
		<div class="panel panel-success">
		  ...
		  <div class="panel-body" style='min-height:500px'>	
			...
			<div>
				...
				<div class="table-responsive">
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='cjzxqmf'><?php if($vo['cjzxsftj']==0&&$vo['cjzxxk']==0&&$vo['cjzxhk']==0){ ?><input class='cj' name="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" id="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxqmf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" id="cjzxqmf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxqmf']); ?>" readonly style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?></td>
						    <td class='cjzxpsf'><?php if($vo['cjzxsftj']==0&&$vo['cjzxxk']==0&&$vo['cjzxhk']==0){ ?><input class='cj' name="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" id="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxpsf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" id="cjzxpsf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxpsf']); ?>" readonly style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?></td>
						    <td class='cjzxxtf'><?php if($vo['cjzxsftj']==0&&$vo['cjzxxk']==0&&$vo['cjzxhk']==0){ ?><input class='cj' name="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" id="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxxtf']); ?>" /><?php }else{ ?><input class='cj' name="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" id="cjzxxtf-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxxtf']); ?>" readonly style='background-color:#ddd;border:1px solid #ccc;' /><?php } ?><input type='hidden' id="cjzxxk-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxxk']); ?>"><input type='hidden' id="cjzxqk-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxqk']); ?>"><input type='hidden' id="cjzxhk-<?php echo ($vo['cjzxid']); ?>" value="<?php echo ($vo['cjzxhk']); ?>"></td>
				...
				<br/><br/><input type='button' id='exportbjcj' value='生成成绩单' class='btn btn-success btn-lg' /><input type='submit' id='exporttrue' style='display:none' value='导出数据' />
				</form>
				<?php } ?>
