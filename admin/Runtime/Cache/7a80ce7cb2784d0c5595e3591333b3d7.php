		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr>
					<td>应缴学费：</td><td><?php echo ($mo['cwyjxfsm']); ?></td><td>实缴学费：</td><td><?php echo ($mo['cwsjxfsm']); ?></td>
					</tr>
					<tr>
					...
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grdid/<?php echo ($mo['f_std_grdid']); ?>/cwid/<?php echo ($mo['cwid']); ?>"  class='btn btn-warning'>前往修改信息</a><?php } ?>
					<div class='clearfix'></div>
					<br/>
					注册情况:
					<div class='clearfix'></div>
