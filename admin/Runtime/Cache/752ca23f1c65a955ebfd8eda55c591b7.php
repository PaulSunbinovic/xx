	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			...
			<div class="panel-body">				
				...
				<tr><td>大专业名称：</td><td><?php echo ($mo['zynm']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/zyid/<?php echo ($mo['zyid']); ?>/grdid/<?php echo ($mo['f_zy_grdid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
