...
<script type='text/javascript' src='__PUBLIC__/JS/admin/tsqk.js'></script>
							...
							<!-- Tab panes -->
							  <div class="tab-content">
							    <div role="tabpanel" class="tab-pane" id="home">
							    	<div id='flddv'>
										<input type="checkbox" id='tsqkidfld' value='tsqkid' style='display:none' checked=checked/>
										<input type="checkbox" id='sttnmfld' value='sttnm'/>站点名称&nbsp;&nbsp;
										<input type="checkbox" id='f_tsqk_grdidfld' value='f_tsqk_grdid' style='display:none' checked=checked/>
										<input type="checkbox" id='grdnmfld' value='grdnm'/>年级&nbsp;&nbsp;
										<input type="checkbox" id='f_tsqk_stdidfld' value='f_tsqk_stdid' style='display:none' checked=checked/>
										
										<input type="checkbox" id='stdnofld' value='stdno'/>学号&nbsp;&nbsp;<br/>
										<input type="checkbox" id='stdnmfld' value='stdnm'/>姓名&nbsp;&nbsp;
										<input type="checkbox" id='tsqktmfld' value='tsqktm'/>时间&nbsp;&nbsp;
										<input type="checkbox" id='tsqknrfld' value='tsqknr'/>事件&nbsp;&nbsp;
										<input type="checkbox" id='tsqkorgidfld' value='tsqkorgid'/>原来&nbsp;&nbsp;
										<input type="checkbox" id='tsqknwidfld' value='tsqknwid'/>后来&nbsp;&nbsp;
										<input type="checkbox" id='tsqkjbrfld' value='tsqkjbr'/>经办人&nbsp;&nbsp;
									</div>
								</div>
							    <div role="tabpanel" class="tab-pane active" id="profile">
									<div id='cdtdv'>
										...
										年级
										<select name='f_tsqk_grdid' id='f_tsqk_grdidcdt'>
							    ...
							    <div role="tabpanel" class="tab-pane" id="messages">
									<div id='odrdv'>
										...
										<option value='tsqktm DESC'>情况处理时间降序</option>
										</select>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='oprt'>班级</th>
					    <th class='oprt'>专业</th>
					    <th class='tsqktm'>时间</th>
					    <th class='tsqknr'>事件</th>
					    <th class='tsqkorgid'>原来</th>
					    <th class='tsqknwid'>现在</th>
					    <th class='tsqkjbr'>经办人</th>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='oprt'><?php echo ($vo['clsnm']); ?></td>
						    <td class='oprt'><?php echo ($vo['mjnm']); ?></td>
						    <td class='tsqktm'><?php echo ($vo['tsqktm']); ?></td>
						    <td class='tsqknr'><?php echo ($vo['tsqknr']); ?></td>
						    <td class='tsqkorgid'><?php echo ($vo['tsqkorgid']); ?></td>
						    <td class='tsqknwid'><?php echo ($vo['tsqknwid']); ?></td>
						    <td class='tsqkjbr'><?php echo ($vo['tsqkjbr']); ?></td>
