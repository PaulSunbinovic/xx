	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='xqnm'>学期</th>
					    <th class='zsszbxxsu'>适应的办学形式</th>
					    <th class='zsszop'>招生开启与否</th>
					    <th class='zsszjztm'>招生缴费截至时间</th>
					    <th class='zsszjztm'>招生小年龄时间</th>
					    <th class='oprt'>操作</th>
					</tr>
					</thead>
					...
					<tbody>
					  ...
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='zsszbxxsu'><?php echo ($vo['zsszbxxsu']); ?></td>
					    <td class='zsszop'><?php echo ($vo['zsszop']); ?></td>
					    <td class='zsszzjtm'><?php echo ($vo['zsszjztm']); ?></td>
					    <td class='zsszxnltm'><?php echo ($vo['zsszxnltm']); ?></td>
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/zsszid/<?php echo ($vo['zsszid']); ?>/grdid/<?php echo ($vo['f_zssz_grdid']); ?>">查看</a><?php } ?>
					      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/zsszid/<?php echo ($vo['zsszid']); ?>">修改</a><?php } ?> 
					      <!-- <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['zsszid']); ?>,<?php echo ($vo['f_zssz_grdid']); ?>)">删除</a><?php } ?> -->
					    </td>
				...
				<!-- <?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/zsszid/0" class='btn btn-primary'>添加</a></p><?php } ?>-->
