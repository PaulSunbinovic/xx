	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
				<form>
				<input type='hidden' name='rlid' value="<?php echo ($mo['rlid']); ?>" />
				<table class='tb'>
				<tr><td>角色名称：</td><td><input type='text' name='rlnm' value="<?php echo ($mo['rlnm']); ?>" id='rlnm' class='form-control input-sm'/></td></tr>
