...
<script type='text/javascript' src='__PUBLIC__/JS/zsptwap/atc.js'></script>
<link rel="stylesheet" href="__PUBLIC__/CSS/zsptwap/atc.css"/>
...
<div class="header FixedTop" id='header'>
	...
	<div class="content" id="content">
        ...
        <div class='detail' style='margin-left:10px;margin-right:10px'>
			<h4 style='text-align:center'><?php echo ($mo['atctpc']); ?></h4>
