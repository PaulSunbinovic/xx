	...
	<div class='col-md-12' style='float:none;margin:0px auto 0;padding:0;' >
		<div class="panel panel-primary">
		  ...
		  <div class="panel-body">
					...
					<table class='tb'>
					<tr><td>用户名：</td><td><input type='text' class="form-control input-sm"  name='usrnm' id='usrnm'/></td></tr>
					<tr><td>密保邮箱：</td><td><input type='text' class="form-control input-sm" name='usrml' id='usrml'/></td></tr>
					</table>
					<br/>
					<input type='button' id='usr_forget' value=<?php echo ($btnvl); ?> class='btn btn-primary'/>
					</form>
			 </div>
		</div>
	</div>
