	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<table class='tb'>
				<tr><td>用户名：</td><td><?php echo ($mo['usrnm']); ?>&nbsp;<?php echo ($mo['usrnn']); ?></td></tr>
				<tr><td>团队名称：</td><td><?php echo ($mo['grpnm']); ?></td></tr>
				<tr><td>角色名称：</td><td><?php echo ($mo['rlnm']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/usrrlid/<?php echo ($mo['usrrlid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
