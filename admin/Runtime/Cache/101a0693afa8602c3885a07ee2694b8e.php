...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='cstmcmtid' value="<?php echo ($mo['cstmcmtid']); ?>" />
				<table class='tb'>
				
				<tr><td>客户用户名</td>
				<td>
				<select name='f_cstmcmt_cstmusrid' disabled class='form-control input-sm'>
					<option value='0'>无</option>
					<?php if(is_array($cstmusrls)): $i = 0; $__LIST__ = $cstmusrls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cstmusrid']); ?>"><?php echo ($vo['cstmusrnn']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				<script>$('select[name=f_cstmcmt_cstmusrid]').val(<?php echo ($mo['f_cstmcmt_cstmusrid']); ?>)</script>
				</td>
				</tr>
				
				<tr><td>文章标题</td>
				<td>
				<select name='f_cstmcmt_atcid' disabled class='form-control input-sm'>
					<option value='0'>无</option>
				...
				<script>$('select[name=f_cstmcmt_atcid]').val(<?php echo ($mo['f_cstmcmt_atcid']); ?>)</script>
				</td>
				</tr>
				<script type="text/javascript" src="__PUBLIC__/pblc/DatePicker/My97DatePickerHHmmss/WdatePicker.js"></script>
				<tr><td>时间</td><td><input name='cstmcmttm' class='form-control input-sm' value="<?php echo ($mo['cstmcmttm']); ?>" onclick="WdatePicker()" readonly style='cursor:auto' />	</td></tr>
				
				<tr><td>内容</td><td><input name='cstmcmtctt' class='form-control input-sm' value="<?php echo ($mo['cstmcmtctt']); ?>" />	</td></tr>
				
				<tr><td>赞</td><td><input name='cstmcmtzn' class='form-control input-sm' value="<?php echo ($mo['cstmcmtzn']); ?>" />	</td></tr>
				
				<tr><td>吐槽</td><td><input name='cstmcmttc' class='form-control input-sm' value="<?php echo ($mo['cstmcmttc']); ?>" />	</td></tr>
