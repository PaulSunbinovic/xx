	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			...
			<div class="panel-body">				
				...
				<tr><td>年级名称：</td><td><?php echo ($mo['grdnm']); ?></td></tr>
				<tr><td>班级名称：</td><td><?php echo ($mo['clsnm']); ?></td></tr>
				<tr><td>班级学号前缀：</td><td><?php echo ($mo['clsxhprx']); ?></td></tr>
				<tr><td>班级激活状态：</td><td><?php echo ($mo['clsactvt']); ?></td></tr>
				<tr><td>班级有效学期：</td><td><?php echo ($mo['clsxqu']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/clsid/<?php echo ($mo['clsid']); ?>/grdid/<?php echo ($mo['f_cls_grdid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
