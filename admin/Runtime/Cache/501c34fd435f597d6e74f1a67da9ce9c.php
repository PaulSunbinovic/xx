	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<form>
						<input type='hidden' name='xfid' value="<?php echo ($mo['xfid']); ?>" />
						<table class='tb'>
						
						<tr><td>年级名称</td>
						<td>
						<select name='f_xf_grdid'>
						...
						<script>$('select[name=f_xf_grdid]').val(<?php echo ($mo['f_xf_grdid']); ?>)</script>
						</td>
						</tr>
						<tr><td>站点名称</td>
						<td>
						<select name='f_xf_sttid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_xf_sttid]').val(<?php echo ($mo['f_xf_sttid']); ?>)</script>
						</td>
						</tr>
						<tr><td>办学形式</td>
						<td>
						<select name='f_xf_bxxsid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_xf_bxxsid]').val(<?php echo ($mo['f_xf_bxxsid']); ?>)</script>
						</td>
						</tr>
						<tr><td>层次</td>
						<td>
						<select name='f_xf_ccid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_xf_ccid]').val(<?php echo ($mo['f_xf_ccid']); ?>)</script>
						</td>
						</tr>
						<tr><td>科类</td>
						<td>
						<select name='f_xf_klid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_xf_klid]').val(<?php echo ($mo['f_xf_klid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>学费数目</td><td><input type='text' name='xfsm'  value="<?php echo ($mo['xfsm']); ?>" /></td>
						</tr>
						<tr>
						<td>教材考务费数目</td><td><input type='text' name='jckwfsm'  value="<?php echo ($mo['jckwfsm']); ?>" /></td>
						</tr>
						</table>
