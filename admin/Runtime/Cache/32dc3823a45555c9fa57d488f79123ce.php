...
<script type='text/javascript' src='__PUBLIC__/JS/admin/jjqk.js'></script>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
							  ...
							  <div class="tab-content">
							    ...
							    <div role="tabpanel" class="tab-pane active" id="profile">
									<div id='cdtdv'>
										...
										<input type='hidden' name='f_stdxqcls_clsid' id='f_stdxqcls_clsidcdt' value='bkl'><!-- bkl：不考虑 -->
										<!-- 
										<br/>
										班级
				...
				<div>
					...
					<?php if(is_array($clsls)): $i = 0; $__LIST__ = $clsls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo ($vo[clsnm]); ?><br/><br/>
						<?php if(is_array($vo['pkls'])): $i = 0; $__LIST__ = $vo['pkls'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voII): $mod = ($i % 2 );++$i;?><li>
								<span class='pull-left'>
									<?php if($voII['pkzkkm']==0){ ?>
									<input type='button' class='btn btn-primary' value="<?php echo ($voII['kcnm']); ?>-<?php echo ($voII['tcrnn']); ?>">
									<?php }else if($voII['pkzkkm']==1){ ?>
									<input type='button' class='btn btn-warning' value="<?php echo ($voII['kcnm']); ?>-<?php echo ($voII['tcrnn']); ?>【自考科目】">
									<?php } ?>
								...
								<span class='pull-right'>
									<?php if($voII['psflg']==0){ ?>
										<input type='button' class='btn btn-info' value="平时分未提交">
									<?php }else if($voII['psflg']==1){ ?>
										<input type='button' class='btn btn-default' value="平时分已提交">
									<?php }else if($voII['psflg']==2){ ?>
										<input type='button' class='btn btn-warning' value="平时分部分提交">
									<?php } ?>
									
									<?php if($voII['jjflg']==0){ ?>
										<input type='button' class='btn btn-success' value="任课教师未提交">
									<?php }else if($voII['jjflg']==1){ ?>
										<input type='button' class='btn btn-default' value="任课教师已提交">
									<?php }else if($voII['jjflg']==2){ ?>
										<input type='button' class='btn btn-warning' value="任课教师部分提交">
									<?php } ?>
								</span>
							</li>
