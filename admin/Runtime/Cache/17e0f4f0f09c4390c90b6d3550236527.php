...
<div class='container' >
	<div class="panel panel-default col-md-12" style='float:none;margin:70px auto 0;padding:0;'>
		...
		<div class="panel-body">
				...
				<tr><td>权限名称：</td><td><?php echo ($mo['athnm']); ?></td></tr>
				<tr><td>模块名称：</td><td><?php echo ($mo['mdnm']); ?></td></tr>
				<tr><td>浏览权限：</td><td><?php echo ($mo['athq']); ?></td></tr>
				<tr><td>查看权限：</td><td><?php echo ($mo['athv']); ?></td></tr>
				<tr><td>更新权限：</td><td><?php echo ($mo['athm']); ?></td></tr>
				<tr><td>删除权限：</td><td><?php echo ($mo['athd']); ?></td></tr>
				<tr><td>添加权限：</td><td><?php echo ($mo['atha']); ?></td></tr>
				</table>
				
				<?php if($u=='y'){ ?><a href="__URL__/gtxpg/x/updt/athmdid/<?php echo ($mo['athmdid']); ?>" class='btn btn-primary'>前往修改信息</a><?php } ?>
