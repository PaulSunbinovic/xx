	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<form>
						<input type='hidden' name='kcid' value="<?php echo ($mo['kcid']); ?>" />
						<table class='tb'>
						...
						<script>$('select[name=f_kc_grdid]').val(<?php echo ($mo['f_kc_grdid']); ?>)</script>
						</td>
						</tr>
						
						<tr><td>课程名称</td>
						<td>
						<input name='kcnm' value="<?php echo ($mo['kcnm']); ?>"/>
						...
						<script>$('select[name=kcsfts]').val(<?php echo ($mo['kcsfts']); ?>)</script>
						</td>
						</tr>
