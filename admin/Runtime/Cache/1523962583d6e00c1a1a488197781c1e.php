	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
					<input type='hidden' name='jqid' id='jqid' value="<?php echo ($mo['jqid']); ?>" />
					<table class='tb'>
					<tr><td>站点名称：</td><td>
						<select name='f_jq_sttid' class='form-control input-sm'>
						...
						<script>$('select[name=f_jq_sttid]').val(<?php echo ($mo['f_jq_sttid']); ?>)</script>
					</td></tr>
					<tr><td>学期：</td><td>
						<select name='f_jq_xqid' class='form-control input-sm'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_jq_xqid]').val(<?php echo ($mo['f_jq_xqid']); ?>)</script>
					</td></tr>
					<script language="javascript" type="text/javascript" src="__PUBLIC__/pblc/DatePicker/My97DatePicker/WdatePicker.js"></script>
							
					<tr><td>起始时间：</td><td><input type='text' name='jqqs' value="<?php echo ($mo['jqqs']); ?>" id='jqqs' class='form-control input-sm' onclick="WdatePicker()" /></td></tr>
					<tr><td>结束时间：</td><td><input type='text' name='jqjs' value="<?php echo ($mo['jqjs']); ?>" id='jqjs' class='form-control input-sm' onclick="WdatePicker()" /></td></tr>
					<tr><td>领教材时间：</td><td><input type='text' name='jqljc' value="<?php echo ($mo['jqljc']); ?>" id='jqljc' class='form-control input-sm' onclick="WdatePicker()" /></td></tr>
