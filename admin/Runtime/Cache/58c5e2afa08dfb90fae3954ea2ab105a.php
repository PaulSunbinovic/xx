	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						<input type='hidden' name='cwid' id='cwid' value="<?php echo ($mo['cwid']); ?>" />
						...
						<div class='mingxi'>
						<input type='hidden' name='cwid' value="<?php echo ($mo['cwid']); ?>" />
						<input type='hidden' name='f_std_grdid' value="<?php echo ($mo['f_std_grdid']); ?>" />
						缴费情况：
						<table>
						
						<tr>
						<td>应缴学费：</td><td><input name='cwyjxfsm' value="<?php echo ($mo['cwyjxfsm']); ?>" alt="<?php echo ($mo['cwyjxfsm']); ?>" /></td><td>实缴学费：</td><td><input name='cwsjxfsm' value="<?php echo ($mo['cwsjxfsm']); ?>" alt="<?php echo ($mo['cwsjxfsm']); ?>" /></td>
						</tr>
						<tr>
						<td>应缴教材考务费：</td><td><input name='cwyjjckwfsm' value="<?php echo ($mo['cwyjjckwfsm']); ?>" alt="<?php echo ($mo['cwyjjckwfsm']); ?>" /></td><td>实缴教材考务费：</td><td><input name='cwsjjckwfsm' value="<?php echo ($mo['cwsjjckwfsm']); ?>" alt="<?php echo ($mo['cwsjjckwfsm']); ?>" /></td>
						</tr>
						<tr>
						<td>应缴住宿费：</td><td><input name='cwyjzsfsm' value="<?php echo ($mo['cwyjzsfsm']); ?>" alt="<?php echo ($mo['cwyjzsfsm']); ?>" /></td><td>实缴住宿费：</td><td><input name='cwsjzsfsm' value="<?php echo ($mo['cwsjzsfsm']); ?>" alt="<?php echo ($mo['cwsjzsfsm']); ?>" /></td>
						</tr>
						<tr>
						<td>应缴总额：</td><td><input name='cwyjze' value="<?php echo ($mo['cwyjze']); ?>" alt="<?php echo ($mo['cwyjze']); ?>" readonly /></td><td>实缴总额：</td><td><input name='cwsjze' value="<?php echo ($mo['cwsjze']); ?>" alt="<?php echo ($mo['cwsjze']); ?>" readonly /></td>
						</tr>
						...
						<div class="list-group col-md-8">
							<?php if(is_array($zcls)): $i = 0; $__LIST__ = $zcls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#" class="list-group-item <?php echo ($vo['zcf']); ?>"><?php echo ($vo['xqnm']); ?>&nbsp;&nbsp;&nbsp;[<?php echo ($vo['zczt']); ?>]&nbsp;&nbsp;&nbsp;<?php echo ($vo['clsnm']); ?>&nbsp;&nbsp;&nbsp;<?php echo ($vo['mjnm']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
						<div class='clearfix'></div>
