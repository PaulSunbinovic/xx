...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='sysid' value="<?php echo ($mo['sysid']); ?>" />
				<table class='tb'>
				<tr><td>系统名称：</td><td><input type='text' name='sysnm' value="<?php echo ($mo['sysnm']); ?>" id='sysnm' class='form-control input-sm'/></td></tr>
				<tr><td>系统IP：</td><td><input type='text' name='sysip' value="<?php echo ($mo['sysip']); ?>" id='sysip' class='form-control input-sm'/></td></tr>
				</table>
