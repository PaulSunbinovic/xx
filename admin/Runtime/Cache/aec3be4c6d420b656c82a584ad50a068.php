...
<script type='text/javascript' src='__PUBLIC__/JS/admin/wx.js'></script>
	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
					<input type='hidden' name='wxid' id='wxid' value="<?php echo ($mo['wxid']); ?>" />
					<table class='tb'>
					<tr><td>微信appid：</td><td><input type='text' name='wxappid' value="<?php echo ($mo['wxappid']); ?>" id='wxappid' class='form-control input-sm'/></td></tr>
					<tr><td>微信secret：</td><td><input type='text' name='wxscrt' value="<?php echo ($mo['wxscrt']); ?>" id='wxscrt' class='form-control input-sm'/></td></tr>
					<tr><td>微信ip：</td><td><input type='text' name='wxip' value="<?php echo ($mo['wxip']); ?>" id='wxip' class='form-control input-sm'/></td></tr>
					<tr><td>微信二维码：</td><td>
					...
					var hdlupload='__APP__/FileUpload/upload/issml/y';////注意
					var upload_path='__ROOT__/Uploads/wx';
					</script>
					<script type="text/javascript" src='__PUBLIC__/pblc/FileUpload/int.js'></script>
					<div>
					<img src="<?php echo ($mo['wxqr']); ?>" alt=""  class='img-thumbnail'  style="width:100px;"  id='imgg'/>
					</div>
					<div style="width:80px; height:26px; overflow:hidden;"><input type="file"  name="photo1" id="uploadify"/></div>
					<!-- 隐藏系统所需的微信upt -->
					<input type='hidden' name='wxqr' value="<?php echo ($mo['wxqr']); ?>" id='pt'/>
					<!-- file over -->
					...
					<tr><td>微信公功能是否启动:</td>
					<td>
					<select name='wxop' class='form-control input-sm'>
						<option value='1'>是</option>
						<option value='0'>否</option>
					</select>
					<script>$('select[name=wxop]').val("<?php echo ($mo['wxop']); ?>");</script>
					</td>
					</tr>
					</table>
