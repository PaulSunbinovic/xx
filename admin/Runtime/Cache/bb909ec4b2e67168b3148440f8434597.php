		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>学期：</td><td><?php echo ($mo['xqnm']); ?></td></tr>
					<tr><td>是否一二三：</td><td><?php echo ($mo['sttintxqyes']); ?></td></tr>
					</table>
					
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/sttintxqid/<?php echo ($mo['sttintxqid']); ?>/grdid/<?php echo ($mo['f_sttintxq_grdid']); ?>"  class='btn btn-primary'>前往修改个人信息</a><?php } ?>
