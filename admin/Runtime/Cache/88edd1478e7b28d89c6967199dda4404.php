	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<form>
						<input type='hidden' name='sttintxqid' value="<?php echo ($mo['sttintxqid']); ?>" />
						<table class='tb'>
						
						<tr><td>年级名称</td>
						<td>
						<select name='f_sttintxq_grdid'>
						...
						<script>$('select[name=f_sttintxq_grdid]').val(<?php echo ($mo['f_sttintxq_grdid']); ?>)</script>
						</td>
						</tr>
						
						<tr><td>站点名称</td>
						<td>
						<select name='f_sttintxq_sttid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_sttintxq_sttid]').val(<?php echo ($mo['f_sttintxq_sttid']); ?>)</script>
						</td>
						</tr>
						
						<tr><td>学期名称</td>
						<td>
						<select name='f_sttintxq_xqid'>
							<option value='0'>无</option>
						...
						<script>$('select[name=f_sttintxq_xqid]').val(<?php echo ($mo['f_sttintxq_xqid']); ?>)</script>
						</td>
						</tr>
						...
						<tr><td>是否一二三</td>
						<td>
						<select name='sttintxqyes'>
							<option value="0">否</option>
							<option value="1">是</option>
						</select>
						<script>$('select[name=sttintxqyes]').val(<?php echo ($mo['sttintxqyes']); ?>)</script>
						</td>
						</tr>
