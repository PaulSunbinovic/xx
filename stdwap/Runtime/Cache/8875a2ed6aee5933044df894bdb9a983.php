...
<div class="header FixedTop" id='header'>
	...
	<div class="content" id="content" style='margin-top:20px'>
		...
		<div class="col-md-12" >
			...
			<div>
				<input type='button' onclick="javascript:window.location.href='__APP__/Cjzx/cxbxqcj'" class='btn btn-success btn-lg btn-block' value='本学期成绩查询'/>
				<input type='button' onclick="javascript:window.location.href='__APP__/Cjzx/cxlncj'" class='btn btn-warning btn-lg btn-block' value='历年成绩查询'/>
