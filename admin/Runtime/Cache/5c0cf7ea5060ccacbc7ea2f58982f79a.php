...
<link rel="stylesheet" href="__PUBLIC__/CSS/admin/xk.css"/>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<a href='__URL__/gtxpg/x/clsjtxk' class='btn btn-success btn-lg'>班级集体选课</a>
					</div>		
					<div style='margin-top:50px;margin-bottom:50px'>
					<a href='__URL__/gtxpg/x/stdgrxk' class='btn btn-warning btn-lg'>学生个人选课</a>
					</div>			
