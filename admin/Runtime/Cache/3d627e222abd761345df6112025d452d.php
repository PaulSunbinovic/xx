	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
			...
			<div class="panel-body">					
				...
				<form>
				<input type='hidden' name='lbid' value="<?php echo ($mo['lbid']); ?>" />
				<table class='tb'>
				<tr><td>类别姓名：</td><td><input type='text' name='lbnm' value="<?php echo ($mo['lbnm']); ?>" id='lbnm' class='form-control input-sm'/></td></tr>
				</table>
