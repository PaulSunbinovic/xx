			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						...
						<input type='hidden' name='f_cjzx_grdid'  value="<?php echo ($grdo['grdid']); ?>" />
						<input type='hidden' name='f_cjzx_sttid'  value="<?php echo ($stto['sttid']); ?>" />
						<input type='hidden' name='f_cjzx_xqid'  value="<?php echo ($xqo['xqid']); ?>" />
						<input type='hidden' name='f_cjzx_stdid'  value="<?php echo ($stdo['stdid']); ?>" />
						...
						<td>
						<select name='f_cjzx_pkid'>
						<option value='0'>无</option>
						<?php if(is_array($pkls)): $i = 0; $__LIST__ = $pkls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['pkid']); ?>"><?php echo ($vo['kcnm']); ?>-<?php echo ($vo['tcrnn']); echo ($vo['pkzkkm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						</td>
						</tr>
