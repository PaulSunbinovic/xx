...
<div class="header FixedTop" id='header'>
	...
	<div class="content" id="content">
		<div class='container' style='margin-top:20px'>
			...
			<div class='col-xs-12'>
				<div class='col-xs-6'><img src="<?php echo ($mo['cstmusrpt']); ?>" class='img-circle' style='height:80px;width:80px;' /></div>
				<div class='col-xs-6'>
					<div><?php echo ($mo['cstmusrnn']); ?></div>
					
				</div>
			</div>
			<script type='text/javascript'>
			hdlurl='__APP__/Cstmusr/combine';
			</script>
			<form>
			  ...
			  <div id='errCtn'></div>
			  <input type="button" class="btn btn-primary" value='帐号绑定' id='cbcnt'>
			  <p>还没有帐号 <a href="__APP__/Cstmusr/gtxpg/x/regist">注册再绑定</a>&nbsp;&nbsp;&nbsp;&nbsp;忘记密码 <a href="__APP__/Cstmusr/gtxpg/x/forget">获取密码</a></p>
			</form>
