	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
			...
			<div class="panel-body">			
				...
				<table class='tb'>
				<tr><td>客户模块标识：</td><td><?php echo ($mo['cstmmdmk']); ?></td></tr>
				<tr><td>客户模块名称：</td><td><?php echo ($mo['cstmmdnm']); ?></td></tr>
				</table>
				
				<?php if($u=='y'){ ?><a href="__URL__/gtxpg/x/updt/cstmmdid/<?php echo ($mo['cstmmdid']); ?>" class='btn btn-primary'>前往修改权限信息</a><?php } ?>
