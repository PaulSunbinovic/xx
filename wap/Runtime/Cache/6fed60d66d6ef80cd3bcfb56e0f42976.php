		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">	
					...
					<tr><td>客户用户头像：</td><td>
						...
						<div><img src="<?php echo ($mo['dsplpt']); ?>" class='thumbnail' style='width:100px;height:100px' id='imgg' /><input type='hidden' name='cstmusrpt' value="<?php echo ($mo['cstmusrpt']); ?>" id='pt' /></div>
						<div id="upload"></div>
					    <!-- pt over -->
