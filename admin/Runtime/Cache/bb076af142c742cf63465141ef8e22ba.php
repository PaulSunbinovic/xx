	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">	
				...
				<tr><td>审核情况：</td><td><?php echo ($mo['usrps']); ?></td></tr>
				<tr><td>用户简介：</td><td><div style='width:700px'><?php echo ($mo['usrintr']); ?></div></td></tr>
				</table>
				
				<a href='__URL__/gtxpg/x/modify' class='btn btn-primary'>前往修改个人信息</a>
				<a href='__URL__/gtxpg/x/modifypw' class='btn btn-primary'>前往修改密码</a>
		  </div>
