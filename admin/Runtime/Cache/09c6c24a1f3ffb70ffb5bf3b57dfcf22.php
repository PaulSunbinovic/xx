...
<script type='text/javascript' src='__PUBLIC__/JS/admin/jq.js'></script>
	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<!-- NB 开始 -->
				    ...
				    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
				      ...
				      <!-- 暂时结束 -->
						<div id='flddv'>
							字段：<!-- uid必须有且不用看见 -->
							<input type="checkbox" id='jqidfld' value='jqid' style='display:none' checked=checked/>
							<input type="checkbox" id='sttnmfld' value='sttnm'/>站点名称&nbsp;&nbsp;
							<input type="checkbox" id='xqnmfld' value='xqnm'/>学期&nbsp;&nbsp;
							<input type="checkbox" id='jqqsfld' value='jqqs'/>起始时间&nbsp;&nbsp;
							<input type="checkbox" id='jqjsfld' value='jqjs'/>结束时间&nbsp;&nbsp;
							<input type="checkbox" id='jqljcfld' value='jqljc'/>领教材时间&nbsp;&nbsp;
							
						</div>
						<div id='cdtdv'>
							条件：
							站点名称
							<select name='sttid' id='sttidcdt' >
						...
						<div id='odrdv' style='display:none'>
							...
							<option value='xqnm DESC'>学期名称降序</option>
							</select>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='xqnm'>学期</th>
					    <th class='jqqs'>起始时间</th>
					    <th class='jqjs'>结束时间</th>
					    <th class='jqljc'>领教材时间</th>
					    <th class='oprt'>操作</th>
					  </tr>
					</thead>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='jqqs'><?php echo ($vo['jqqs']); ?></td>
					    <td class='jqjs'><?php echo ($vo['jqjs']); ?></td>
					    <td class='jqljc'><?php echo ($vo['jqljc']); ?></td>
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/jqid/<?php echo ($vo['jqid']); ?>">查看</a><?php } ?>
					      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/jqid/<?php echo ($vo['jqid']); ?>">修改</a><?php } ?> 
					      <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['jqid']); ?>)">删除</a><?php } ?>
				...
				<?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/jqid/0" class='btn btn-primary'>添加</a></p><?php } ?>
