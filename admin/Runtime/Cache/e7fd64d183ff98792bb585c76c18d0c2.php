...
<script type='text/javascript' src='__PUBLIC__/JS/admin/grp.js'></script>
...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='grpid' value="<?php echo ($mo['grpid']); ?>" />
				<table class='tb'>
				<tr><td>团队名：</td><td><input type='text' name='grpnm' value="<?php echo ($mo['grpnm']); ?>" id='grpnm' class='form-control input-sm'/></td></tr>
				</table>
				<input type='hidden' name='grppid' value="<?php echo ($mo['grppid']); ?>" />
				<input type='hidden' name='grpodr' value="<?php echo ($mo['grpodr']); ?>" />
