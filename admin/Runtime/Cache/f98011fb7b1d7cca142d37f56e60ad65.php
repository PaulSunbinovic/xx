	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>;'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt' >
			<div class="panel panel-default">
				...
				<!-- NB 开始 -->
				    ...
				    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
				      ...
				      <!-- 暂时结束 -->
						<div id='flddv'>
							字段：<!-- uid必须有且不用看见 -->
							<input type="checkbox" id='grprlidfld' value='grprlid' style='display:none' checked=checked/>
						...
						<div id='cdtdv'>
							条件：
							团队名称
							<select name='f_grprl_grpid' id='f_grprl_grpidcdt'  class='input-small'>
							<option value=''>无</option>
							<?php echo ($tree); ?>
							</select>
							&nbsp;&nbsp;
							角色名称
							<select name='f_grprl_rlid' id='f_grprl_rlidcdt'  class='input-small'>
							<option value=''>无</option>
				...
				<div class="table-responsive">
					...
					<tbody>
					  ...
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/grprlid/<?php echo ($vo['grprlid']); ?>">查看</a><?php } ?>
					      <!-- <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/grprlid/<?php echo ($vo['grprlid']); ?>">修改</a><?php } ?> -->
					      <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['grprlid']); ?>)">删除</a><?php } ?>
					    </td>
				...
				<?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/grprlid/0" class='btn btn-primary'>添加</a></p><?php } ?>
