...
<script type='text/javascript' src='__PUBLIC__/JS/admin/bd.js'></script>
...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='bdid' value="<?php echo ($mo['bdid']); ?>" />
				<table class='tb'>
				<tr><td>板块名：</td><td><input type='text' name='bdnm' value="<?php echo ($mo['bdnm']); ?>" id='bdnm' class='form-control input-sm'/></td></tr>
				</table>
				<input type='hidden' name='bdpid' value="<?php echo ($mo['bdpid']); ?>" />
				<input type='hidden' name='bdodr' value="<?php echo ($mo['bdodr']); ?>" />
