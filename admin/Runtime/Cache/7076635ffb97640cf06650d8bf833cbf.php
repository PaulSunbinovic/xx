			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						...
						<tr>
						<td>姓名：</td><td>
							<?php if($athm!=1){ ?><input type='text' name='stdnm' value="<?php echo ($mo['stdnm']); ?>" id='stdnm' disabled/><?php }else{ ?><input type='text' name='stdnm' value="<?php echo ($mo['stdnm']); ?>" id='stdnm' /><?php } ?></td>
						</td>
						<td>
						性别：
						</td>
						...
						<tr>
						<td>身份证号码：</td><td>
						<?php if($athm!=1){ ?><input type='text' name='stdidcd' value="<?php echo ($mo['stdidcd']); ?>" id='stdidcd' disabled/><?php }else{ ?><input type='text' name='stdidcd' value="<?php echo ($mo['stdidcd']); ?>" id='stdidcd' /><?php } ?></td>
						</td>
						...
						<td>家庭地址：</td><td colspan=3><input type='text' name='stdads' value="<?php echo ($mo['stdads']); ?>" id='stdads' style="width: 330px" /></td>
