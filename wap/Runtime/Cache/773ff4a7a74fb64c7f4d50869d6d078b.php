			     ...
			     <div class="form-group">
			    	<label class='col-md-2  control-label' for="cstmusrpt">客户用户头像</label>
			   		<div class="col-md-4">
						...
						<div><img src="<?php echo ($mo['cstmusrpt']); ?>" class='thumbnail' style='width:100px;height:100px' id='imgg' /><input type='hidden' name='cstmusrpt' value="<?php echo ($mo['cstmusrpt']); ?>" id='pt' /></div>
						<div id="upload"></div>
						<!-- pt over -->
