...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='plid' value="<?php echo ($mo['plid']); ?>" />
				<input type='hidden' name='f_pl_grdid' value="<?php echo ($mo['f_pl_grdid']); ?>" />
				<input type='hidden' name='f_pl_sttid' value="<?php echo ($mo['f_pl_sttid']); ?>" />
				<input type='hidden' name='f_pl_xqid' value="<?php echo ($mo['f_pl_xqid']); ?>" />
				<input type='hidden' name='f_pl_stdid' value="<?php echo ($mo['f_pl_stdid']); ?>" />
				<table  class='tb'>
				<tr><td>年级：</td><td><?php echo ($stdo['grdnm']); ?></td></tr>
				<tr><td>站点：</td><td><?php echo ($stdo['sttnm']); ?></td></tr>
				<tr><td>学期：</td><td><?php echo ($stdo['xqnm']); ?></td></tr>
				<tr><td>学号：</td><td><?php echo ($stdo['stdno']); ?></td></tr>
				<tr><td>姓名：</td><td><?php echo ($stdo['stdnm']); ?></td></tr>
				...
				<script type="text/javascript">
					var editor = new baidu.editor.ui.Editor({
					    initialContent: '<?php echo ($mo["plctt"]); ?>'
					});
					editor.render("myEditor");
				</script>
				</div> 
				<textarea name='plctt' style='display:none'></textarea>-->
				<textarea name='plctt' style='width:600px;height:300px'><?php echo ($mo['plctt']); ?></textarea>
				<br/>
