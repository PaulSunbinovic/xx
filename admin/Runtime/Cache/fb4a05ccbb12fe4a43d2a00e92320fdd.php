...
<script type='text/javascript' src='__PUBLIC__/JS/admin/stt.js'></script>
...
<div class='container' >
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form>
				<input type='hidden' name='sttid' value="<?php echo ($mo['sttid']); ?>" />
				<table  class='tb'>
				<tr><td>站点名称：</td><td><input type='text' name='sttnm' value="<?php echo ($mo['sttnm']); ?>" id='sttnm'/></td></tr>
				<tr><td>站点单位：</td><td><input type='text' name='sttcprt' value="<?php echo ($mo['sttcprt']); ?>" id='sttcprt'/></td></tr>
				<tr><td>站点地址：</td><td><input type='text' name='sttads' value="<?php echo ($mo['sttads']); ?>" id='sttads'/></td></tr>
				<tr><td>站点负责人姓名：</td><td><input type='text' name='sttrspnm' value="<?php echo ($mo['sttrspnm']); ?>" id='sttrspnm'/></td></tr>
				<tr><td>站点负责人固话：</td><td><input type='text' name='sttrsptlp' value="<?php echo ($mo['sttrsptlp']); ?>" id='sttrsptlp'/></td></tr>
				<tr><td>站点负责人手机号：</td><td><input type='text' name='sttrspcp' value="<?php echo ($mo['sttrspcp']); ?>" id='sttrspcp'/></td></tr>
				
				<tr><td>站点激活情况：</td>
				<td>
				<select name='sttactvt'>
					<option value='0'>未激活</option>
					<option value='1'>激活</option>
				</select>
				<script>$('select[name=sttactvt]').val("<?php echo ($mo['sttactvt']); ?>")</script>
				</td>
				</tr>
				...
				<script type="text/javascript">
					var editor = new baidu.editor.ui.Editor({
					    initialContent: '<?php echo ($mo["sttdsc"]); ?>'
					});
					editor.render("myEditor");
				</script>
				</div>
				<textarea name='sttdsc' style='display:none'></textarea>
