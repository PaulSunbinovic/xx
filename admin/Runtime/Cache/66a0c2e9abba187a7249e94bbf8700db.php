		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php if($mo['mdf']==1){ ?><a href="__URL__/gtxpg/x/mdf/stdid/<?php echo ($mo['stdid']); ?>" class='btn btn-info'>更改基本信息</a><?php } ?> 
					<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/stdid/<?php echo ($mo['stdid']); ?>"  class='btn btn-warning'>前往修改信息</a><?php } ?>
					<div class='clearfix'></div>
					<br/>
