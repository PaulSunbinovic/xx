	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt'>
		<div class="panel panel-default">
			...
			<div class="panel-body">					
				...
				<form>
				<input type='hidden' name='cstmmdid' value="<?php echo ($mo['cstmmdid']); ?>" />
				<table class='tb'>
				<tr><td>客户模块标识：</td><td><input type='text' name='cstmmdmk' value="<?php echo ($mo['cstmmdmk']); ?>" id='cstmmdmk' class='form-control input-sm'/></td></tr>
				<tr><td>客户模块姓名：</td><td><input type='text' name='cstmmdnm' value="<?php echo ($mo['cstmmdnm']); ?>" id='cstmmdnm' class='form-control input-sm'/></td></tr>
				</table>
