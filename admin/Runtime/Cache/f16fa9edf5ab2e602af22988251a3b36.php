			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    <th class='odr'>序号</th>
					    <th class='wxappid'>微信appid</th>
					    <th class='wxscrt'>微信secret</th>
					    <th class='wxip'>微信ip</th>
					    <th class='wxop'>微信功能是否打开</th>
					    <th class='oprt'>操作</th>
					  </tr>
					</thead>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					    ...
					    <td class='wxappid'><?php echo ($vo['wxappid']); ?></td>
					    <td class='wxscrt'><?php echo ($vo['wxscrt']); ?></td>
					   	<td class='wxip'><?php echo ($vo['wxip']); ?></td>
					    <td class='wxop'><?php echo ($vo['wxop']); ?></td>
					    <td class='oprt'>
					      <!-- Icons -->
					      <?php if($athv==1){ ?><a href="__URL__/gtxpg/x/vw/wxid/<?php echo ($vo['wxid']); ?>">查看</a><?php } ?>
					      <?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/wxid/<?php echo ($vo['wxid']); ?>">修改</a><?php } ?> 
					      <!-- <?php if($athd==1){ ?><a href="javascript:dlt(<?php echo ($vo['wxid']); ?>)">删除</a><?php } ?> -->
				...
				<!-- <?php if($atha==1){ ?><p><a href="__URL__/gtxpg/x/updt/wxid/0" class='btn btn-primary'>添加</a></p><?php } ?> -->
