...
<script type='text/javascript' src='__PUBLIC__/JS/admin/sys.js'></script>
	...
	<div class='<?php echo ($rgtcls); ?>' id='rgt' >
		<div class="panel panel-default">
			...
			<div class="panel-body">		
				...
				<table class='tb'>
				<tr><td>系统名称：</td><td><?php echo ($mo['sysnm']); ?></td></tr>
				<tr><td>系统IP：</td><td><?php echo ($mo['sysip']); ?></td></tr>
				</table>
				
				<?php if($athm==1){ ?><a href="__URL__/gtxpg/x/updt/sysid/<?php echo ($mo['sysid']); ?>" class='btn btn-primary'>前往修改权限信息</a><?php } ?>
