		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class='tb'>
					<tr><td>原密码：</td><td><input type='password' name='usrpworg' class='form-control input-sm'/></td></tr>
					...
					<input type='button' id='usr_modifypw' value=<?php echo ($btnvl); ?> class='btn btn-primary' />
					</form>
				</div>
			</div>
		</div>
