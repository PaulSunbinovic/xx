...
<link rel="stylesheet" href="__PUBLIC__/CSS/admin/cjzx.css"/>
<script type='text/javascript' src='__PUBLIC__/JS/admin/cjzx.js'></script>
<script type='text/javascript'>
var hdlurl='__URL__/update';
var hdlcrtu='__URL__/createAlways';
</script>
<script>var wqm="<?php echo ($mo['pkwqm']); ?>";var wps="<?php echo ($mo['pkwps']); ?>";var wxt="<?php echo ($mo['pkwxt']); ?>";</script>
</head>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form>
						...
						<input type='hidden' name='wqm' value="<?php echo ($mo['pkwqm']); ?>" />
						<input type='hidden' name='wps' value="<?php echo ($mo['pkwps']); ?>" />
						<input type='hidden' name='wxt' value="<?php echo ($mo['pkwxt']); ?>" />
						
						<input type='hidden' name='cjzxid' id='cjzxid' value="<?php echo ($mo['cjzxid']); ?>" />
						<input type='hidden' name='f_cjzx_grdid'  value="<?php echo ($mo['f_cjzx_grdid']); ?>" />
						...
						<script>$('select[name=f_cjzx_sttid]').val(<?php echo ($mo['f_cjzx_sttid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<script>$('select[name=f_cjzx_grdid]').val(<?php echo ($mo['f_cjzx_grdid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<script>$('select[name=f_cjzx_xqid]').val(<?php echo ($mo['f_cjzx_xqid']); ?>)</script>
						</td>
						...
						<td>
						<select name='f_cjzx_kcid'>
							<option value='0'>无</option>
							<?php if(is_array($kcls)): $i = 0; $__LIST__ = $kcls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['kcid']); ?>"><?php echo ($vo['kcnm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						<script>$('select[name=f_cjzx_kcid]').val(<?php echo ($mo['f_cjzx_kcid']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<select name='f_cjzx_tcrid'>
							<option value='0'>无</option>
							<?php if(is_array($tcrls)): $i = 0; $__LIST__ = $tcrls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['tcrid']); ?>"><?php echo ($vo['tcrnn']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						<script>$('select[name=f_cjzx_tcrid]').val(<?php echo ($mo['f_cjzx_tcrid']); ?>)</script>
						</td>
						</tr>
						 -->
						 <tr>
						...
						<td>
						<?php echo ($mo['kcnm']); echo ($mo['pkzkkm']); ?>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<input class='cj' id="cjzxqmf-<?php echo ($mo['cjzxid']); ?>" name='cjzxqmf' value="<?php echo ($mo['cjzxqmf']); ?>"/>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<input class='cj' id="cjzxpsf-<?php echo ($mo['cjzxid']); ?>" name='cjzxpsf' value="<?php echo ($mo['cjzxpsf']); ?>"/>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<input class='cj' id="cjzxxtf-<?php echo ($mo['cjzxid']); ?>" name='cjzxxtf' value="<?php echo ($mo['cjzxxtf']); ?>"/>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<input class='cj1' id="cjzxzf-<?php echo ($mo['cjzxid']); ?>" name='cjzxzf' value="<?php echo ($mo['cjzxzf']); ?>"/>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<input name='cjzxbkf' value="<?php echo ($mo['cjzxbkf']); ?>"/>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<select name='cjzxsftj'>
							<option value='0'>否</option>
							<option value='1'>是</option>
							
						</select>
						<script>$('select[name=cjzxsftj]').val(<?php echo ($mo['cjzxsftj']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<select name='cjzxxk' id="cjzxxk-<?php echo ($mo['cjzxid']); ?>">
							<option value='0'>否</option>
							<option value='1'>是</option>
							
						</select>
						<script>$('select[name=cjzxxk]').val(<?php echo ($mo['cjzxxk']); ?>)</script>
						</td>
						</tr>
						<tr>
						<td>
						...
						<td>
						<select name='cjzxqk' id="cjzxqk-<?php echo ($mo['cjzxid']); ?>">
							<option value='0'>否</option>
							<option value='1'>是</option>
							
						</select>
						<script>$('select[name=cjzxqk]').val(<?php echo ($mo['cjzxqk']); ?>)</script>
						</td>
						</tr>
						...
						<td>
						<select name='cjzxhk' id="cjzxhk-<?php echo ($mo['cjzxid']); ?>">
							<option value='0'>否</option>
							<option value='1'>是</option>
							
						</select>
						<script>$('select[name=cjzxhk]').val(<?php echo ($mo['cjzxhk']); ?>)</script>
						</td>
						</tr>
						</table>
