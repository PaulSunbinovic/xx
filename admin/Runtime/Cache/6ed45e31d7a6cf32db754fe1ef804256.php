	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
							  ...
							  <div class="tab-content">
							    ...
							    <div role="tabpanel" class="tab-pane active" id="profile">
									<div id='cdtdv'>
										...
										排学号时间
										<select name='zspxhtm' id='zspxhtm'>
										<option value=''>无</option>
										<?php if(is_array($zspxhtmls)): $i = 0; $__LIST__ = $zspxhtmls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol['zspxhtm']); ?>"><?php echo ($vol['zspxhtm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										上传后勤时间
										<select name='zspxhschqtm' id='zspxhschqtm'>
										<option value=''>无</option>
										<?php if(is_array($zspxhschqtmls)): $i = 0; $__LIST__ = $zspxhschqtmls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol['zspxhschqtm']); ?>"><?php echo ($vol['zspxhschqtm']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										<br/>
				...
				<div class="table-responsive">
					...
					<thead>
					  <tr class='info'>
					    ...
					    <th class='zspxhtm'>排学号的时间</th>
					    <th class='zspxhschqtm'>上传后勤时间</th>
					...
					<tbody>
					  <?php if(is_array($mls)): $i = 0; $__LIST__ = $mls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						    ...
						    <td class='zspxhtm'><?php echo ($vo['zspxhtm']); ?></td>
				...
				<br>
				<hr>
				<script>var hdlplpxhall='__URL__/plpxh/mk/all';</script>
				<a class='btn btn-success btn-lg' id='plpxhall'><i class='glyphicon glyphicon-list-alt'></i> 批量排学号（不管照片）</a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<script>var hdlplpxhzp='__URL__/plpxh/mk/zp';</script>
				<a class='btn btn-warning btn-lg' id='plpxhzp'><i class='glyphicon glyphicon-list-alt'></i> 批量排学号（只给有照片的学生排）</a>
				<hr>
				<a class='btn btn-primary btn-lg' id='plschqall' href='__URL__/zfk/mk/all'><i class='glyphicon glyphicon glyphicon-file'></i> 产生材料给后勤制作饭卡（不管照片）</a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a class='btn btn-danger btn-lg' id='plschqzp' href='__URL__/zfk/mk/zp'><i class='glyphicon glyphicon glyphicon-file'></i> 产生材料给后勤制作饭卡（只给有照片的学生排）</a>
				<br><br>
