	...
	<div class='col-md-2' id='lft' class='pull-left' style='display:<?php echo ($lftcls); ?>'>
		...
		<div class='<?php echo ($rgtcls); ?>' id='rgt'>
			<div class="panel panel-default">
				...
				<div class="panel-body">	
				<form>
				<input type='hidden' name='cstmrlid' value="<?php echo ($mo['cstmrlid']); ?>" />
				<table class='tb'>
				<tr><td>客户角色：</td><td><input type='text' name='cstmrlnm' value="<?php echo ($mo['cstmrlnm']); ?>" id='cstmrlnm' class='form-control input-sm'/></td></tr>
